...
ChatMessageResult WorldSession::HandleChatMessage(ChatMsg type, Language lang, std::string msg, std::string target /*= ""*/)
{
...
void WorldSession::HandleChatAddonMessageOpcode(WorldPackets::Chat::ChatAddonMessage& chatAddonMessage)
{
    ...
    switch (chatAddonMessage.GetOpcode())
    {
        ...
        case CMSG_CHAT_ADDON_MESSAGE_INSTANCE_CHAT:
            ...
            break;
        default:
            TC_LOG_ERROR("network", "HandleChatAddonMessageOpcode: Unknown addon chat opcode ({})", chatAddonMessage.GetOpcode());
            return;
    }
