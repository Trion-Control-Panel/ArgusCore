...
enum WorldFloatConfigs : uint32
{
    ...
    CONFIG_MAP_PARTITIONING_HALO_WIDTH,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_CHARACTER_CREATING_DEMON_HUNTERS_PER_REALM,
    ...
    CONFIG_LAYER_MAX_PLAYERS,
    CONFIG_LAYER_MIN_PLAYERS,
    ...
    CONFIG_MAP_PARTITIONING_MIN_POPULATION_FOR_FANOUT,
