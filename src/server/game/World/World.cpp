...
void World::LoadConfigSettings(bool reload)
{
    ...
    uint32 hotfixCacheVersion = m_int_configs[CONFIG_HOTFIX_CACHE_VERSION];
    ...
    { {
        ...
        { .Name = "FeatureSystem.BpayStore.Enabled"sv, .DefaultValue = false, .Index = CONFIG_FEATURE_SYSTEM_BPAY_STORE_ENABLED },
    ...
    { {
        ...
        { .Name = "CharactersPerAccount"sv, .DefaultValue = 50, .Index = CONFIG_CHARACTERS_PER_ACCOUNT, .Min = 1 },
        { .Name = "CharacterCreating.DemonHuntersPerRealm"sv, .DefaultValue = 1, .Index = CONFIG_CHARACTER_CREATING_DEMON_HUNTERS_PER_REALM, .Min = 1, .Max = MAX_CHARACTERS_PER_REALM },
        { .Name = "CharacterCreating.MinLevelForDemonHunter"sv, .DefaultValue = 70, .Index = CONFIG_CHARACTER_CREATING_MIN_LEVEL_FOR_DEMON_HUNTER },
        ...
        { .Name = "StartDeathKnightPlayerLevel"sv, .DefaultValue = 55, .Index = CONFIG_START_DEATH_KNIGHT_PLAYER_LEVEL, .Min = 1 },
        { .Name = "StartDemonHunterPlayerLevel"sv, .DefaultValue = 98, .Index = CONFIG_START_DEMON_HUNTER_PLAYER_LEVEL, .Min = 1 },
        { .Name = "StartAlliedRacePlayerLevel"sv, .DefaultValue = 20, .Index = CONFIG_START_ALLIED_RACE_LEVEL, .Min = 1 },
        ...
        { .Name = "Currency.StartArtifactKnowledge"sv, .DefaultValue = 55, .Index = CONFIG_CURRENCY_START_ARTIFACT_KNOWLEDGE, .Min = 0 },
        ...
        { .Name = "HotfixCacheVersion"sv, .DefaultValue = 0, .Index = CONFIG_HOTFIX_CACHE_VERSION },
        ...
        { .Name = "Arena.ArenaSeason.ID"sv, .DefaultValue = 15, .Index = CONFIG_ARENA_SEASON_ID },
    ...
    { {
        ...
        { .Name = "Rate.Talent"sv, .DefaultValue = 1.0f, .Index = RATE_TALENT, .Min = 0.0f },
    } };
    ...
    if (!m_int_configs[CONFIG_HOTFIX_CACHE_VERSION])
        m_int_configs[CONFIG_HOTFIX_CACHE_VERSION] = hotfixCacheVersion;

    TC_LOG_INFO("server.loading", "Client cache version set to: {}", m_int_configs[CONFIG_CLIENTCACHE_VERSION]);

    TC_LOG_INFO("server.loading", "Hotfix cache version set to: {}", m_int_configs[CONFIG_HOTFIX_CACHE_VERSION]);
