...
class TC_GAME_API Player final : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool TeleportTo(WorldSafeLocsEntry const* loc, TeleportToOptions options = TELE_TO_NONE, Optional<uint32> instanceId = {}, uint32 teleportSpellId = 0);
    ...
    public:
        ...
        Item* StoreNewItem(ItemPosCountVec const& pos, uint32 itemId, bool update, ItemRandomEnchantmentId const& randomPropertyId = {}, GuidSet const& allowedLooters = GuidSet(), ItemContext context = ItemContext::NONE, std::vector<int32> const* bonusListIDs = nullptr, bool addToCollection = true);
        ...
        void SetBuybackTimestamp(uint32 slot, uint32 timestamp) { SetUInt32Value(PLAYER_FIELD_BUYBACK_TIMESTAMP_1 + slot, timestamp); }
    ...
    static void SavePositionInDB(WorldLocation const& loc, uint16 zoneId, ObjectGuid guid, CharacterDatabaseTransaction trans);
        ...
        void SendMailResult(uint32 mailId, MailResponseType mailAction, MailResponseResult mailError, uint32 equipError = 0, ObjectGuid::LowType itemGuid = UI64LIT(0), uint32 itemCount = 0) const;
        ...
        void AddToy(uint32 itemId) { AddDynamicValue(PLAYER_DYNAMIC_FIELD_TOYS, itemId); }
        ...
        void RemoveTrackResourceFlag(uint32 flags) { RemoveFlag(PLAYER_TRACK_RESOURCES, flags); }
