...
class TC_GAME_API Item : public Object
{
    ...
    public:
        ...
        void SetBonuses(std::vector<uint32> const& bonusListIDs);
        void SetBonuses(std::vector<int32> const& bonusListIDs);
        void ClearBonuses();
        ...
        ItemContext GetContext() const { return ItemContext(GetUInt32Value(ITEM_FIELD_CONTEXT)); }
