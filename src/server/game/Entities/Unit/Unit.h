...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        uint8 GetEffectiveLevel() const { return uint8(GetUInt32Value(UNIT_FIELD_EFFECTIVE_LEVEL) ? GetUInt32Value(UNIT_FIELD_EFFECTIVE_LEVEL) : GetUInt32Value(UNIT_FIELD_LEVEL)); }
        ...
        void ApplyModPowerCostModifier(SpellSchools school, int32 mod, bool apply) { ApplyModInt32Value(UNIT_FIELD_POWER_COST_MODIFIER + AsUnderlyingType(school), mod, apply); }
        void ApplyModPowerCostMultiplier(SpellSchools school, float pct, bool apply) { ApplyModSignedFloatValue(UNIT_FIELD_POWER_COST_MULTIPLIER + AsUnderlyingType(school), pct, apply); }
        ...
        void HandleEmoteCommand(Emote emoteId, Player* target = nullptr);
        ...
        ObjectGuid GetCreatorGUID() const override { return GetGuidValue(UNIT_FIELD_CREATEDBY); }
        ...
        void SetAttackPowerModPos(int32 attackPowerMod) { SetInt32Value(UNIT_FIELD_ATTACK_POWER_MOD_POS, attackPowerMod); }
        void SetAttackPowerModNeg(int32 attackPowerMod) { SetInt32Value(UNIT_FIELD_ATTACK_POWER_MOD_NEG, attackPowerMod); }
        ...
        void SetRangedAttackPowerModPos(int32 attackPowerMod) { SetInt32Value(UNIT_FIELD_RANGED_ATTACK_POWER_MOD_POS, attackPowerMod); }
        void SetRangedAttackPowerModNeg(int32 attackPowerMod) { SetInt32Value(UNIT_FIELD_RANGED_ATTACK_POWER_MOD_NEG, attackPowerMod); }
