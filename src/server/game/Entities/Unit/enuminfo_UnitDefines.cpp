...
TC_API_EXPORT EnumText EnumUtils<MovementFlags2>::ToString(MovementFlags2 value)
{
    switch (value)
    {
        ...
        case MOVEMENTFLAG2_JUMP_SPLINE_IN_AIR: return { "MOVEMENTFLAG2_JUMP_SPLINE_IN_AIR", "MOVEMENTFLAG2_JUMP_SPLINE_IN_AIR", "" };
        case MOVEMENTFLAG2_ANIM_TIER_IN_TRANS: return { "MOVEMENTFLAG2_ANIM_TIER_IN_TRANS", "MOVEMENTFLAG2_ANIM_TIER_IN_TRANS", "" };
        ...
        case MOVEMENTFLAG2_UNK11: return { "MOVEMENTFLAG2_UNK11", "MOVEMENTFLAG2_UNK11", "terrain normal calculation is disabled if this flag is not present, client automatically handles setting this flag" };
        ...
        case MOVEMENTFLAG2_UNK13: return { "MOVEMENTFLAG2_UNK13", "MOVEMENTFLAG2_UNK13", "set automatically by the client for aura 373" };
        ...
        case MOVEMENTFLAG2_UNK15: return { "MOVEMENTFLAG2_UNK15", "MOVEMENTFLAG2_UNK15", "" };
        ...
        case MOVEMENTFLAG2_UNK18: return { "MOVEMENTFLAG2_UNK18", "MOVEMENTFLAG2_UNK18", "" };
...
template <>
TC_API_EXPORT size_t EnumUtils<MovementFlags2>::Count() { return 24; }
...
TC_API_EXPORT MovementFlags2 EnumUtils<MovementFlags2>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 7: return MOVEMENTFLAG2_JUMP_SPLINE_IN_AIR;
        case 8: return MOVEMENTFLAG2_ANIM_TIER_IN_TRANS;
        case 9: return MOVEMENTFLAG2_WATERWALKING_FULL_PITCH;
        case 10: return MOVEMENTFLAG2_VEHICLE_PASSENGER_IS_TRANSITION_ALLOWED;
        case 11: return MOVEMENTFLAG2_CAN_SWIM_TO_FLY_TRANS;
        case 12: return MOVEMENTFLAG2_UNK11;
        case 13: return MOVEMENTFLAG2_CAN_TURN_WHILE_FALLING;
        case 14: return MOVEMENTFLAG2_UNK13;
        case 15: return MOVEMENTFLAG2_IGNORE_MOVEMENT_FORCES;
        case 16: return MOVEMENTFLAG2_UNK15;
        case 17: return MOVEMENTFLAG2_CAN_DOUBLE_JUMP;
        case 18: return MOVEMENTFLAG2_DOUBLE_JUMP;
        case 19: return MOVEMENTFLAG2_UNK18;
        case 20: return MOVEMENTFLAG2_AWAITING_LOAD;
        case 21: return MOVEMENTFLAG2_INTERPOLATED_MOVEMENT;
        case 22: return MOVEMENTFLAG2_INTERPOLATED_TURNING;
        case 23: return MOVEMENTFLAG2_INTERPOLATED_PITCHING;
        default: throw std::out_of_range("index");
    }
}
...
TC_API_EXPORT size_t EnumUtils<MovementFlags2>::ToIndex(MovementFlags2 value)
{
    switch (value)
    {
        ...
        case MOVEMENTFLAG2_JUMP_SPLINE_IN_AIR: return 7;
        case MOVEMENTFLAG2_ANIM_TIER_IN_TRANS: return 8;
        case MOVEMENTFLAG2_WATERWALKING_FULL_PITCH: return 9;
        case MOVEMENTFLAG2_VEHICLE_PASSENGER_IS_TRANSITION_ALLOWED: return 10;
        case MOVEMENTFLAG2_CAN_SWIM_TO_FLY_TRANS: return 11;
        case MOVEMENTFLAG2_UNK11: return 12;
        case MOVEMENTFLAG2_CAN_TURN_WHILE_FALLING: return 13;
        case MOVEMENTFLAG2_UNK13: return 14;
        case MOVEMENTFLAG2_IGNORE_MOVEMENT_FORCES: return 15;
        case MOVEMENTFLAG2_UNK15: return 16;
        case MOVEMENTFLAG2_CAN_DOUBLE_JUMP: return 17;
        case MOVEMENTFLAG2_DOUBLE_JUMP: return 18;
        case MOVEMENTFLAG2_UNK18: return 19;
        case MOVEMENTFLAG2_AWAITING_LOAD: return 20;
        case MOVEMENTFLAG2_INTERPOLATED_MOVEMENT: return 21;
        case MOVEMENTFLAG2_INTERPOLATED_TURNING: return 22;
        case MOVEMENTFLAG2_INTERPOLATED_PITCHING: return 23;
        default: throw std::out_of_range("value");
    }
}
}
