...
enum OpcodeClient : uint16
{
    ...
    CMSG_ADVENTURE_MAP_START_QUEST                    = 0x332E,
    ...
    CMSG_AUCTION_LIST_BIDDED_ITEMS                    = 0x34D5,
    CMSG_AUCTION_LIST_ITEMS                           = 0x34D2,
    CMSG_AUCTION_LIST_OWNED_ITEMS                     = 0x34D4,
    ...
    CMSG_AUTO_GUILD_BANK_ITEM                         = 0x34BB,
    CMSG_AUTO_STORE_BAG_ITEM                          = 0x399B,
    CMSG_AUTO_STORE_GUILD_BANK_ITEM                   = 0x34C4,
    ...
    CMSG_COMMERCE_TOKEN_GET_COUNT                     = 0x36E5,
    CMSG_COMMERCE_TOKEN_GET_LOG                       = 0x36EF,
    CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE              = 0x36E6,
    ...
    CMSG_CONSUMABLE_TOKEN_BUY                         = 0x36EA,
    CMSG_CONSUMABLE_TOKEN_BUY_AT_MARKET_PRICE         = 0x36EB,
    CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY             = 0x36E9,
    CMSG_CONSUMABLE_TOKEN_REDEEM                      = 0x36ED,
    CMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRMATION         = 0x36EE,
    CMSG_CONTRIBUTION_CONTRIBUTE                      = 0x3558,
    CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST             = 0x3559,
    ...
    CMSG_MERGE_GUILD_BANK_ITEM_WITH_GUILD_BANK_ITEM   = 0x34C5,
    CMSG_MERGE_GUILD_BANK_ITEM_WITH_ITEM              = 0x34C2,
    CMSG_MERGE_ITEM_WITH_GUILD_BANK_ITEM              = 0x34C0,
    ...
    CMSG_MOVE_GUILD_BANK_ITEM                         = 0x34BF,
    ...
    CMSG_SPLIT_GUILD_BANK_ITEM_TO_INVENTORY           = 0x34C3,
    CMSG_SPLIT_ITEM                                   = 0x399E,
    CMSG_SPLIT_ITEM_TO_GUILD_BANK                     = 0x34C1,
    ...
    CMSG_STORE_GUILD_BANK_ITEM                        = 0x34BC,
    ...
    CMSG_SWAP_GUILD_BANK_ITEM_WITH_GUILD_BANK_ITEM    = 0x34BE,
    CMSG_SWAP_INV_ITEM                                = 0x399D,
    CMSG_SWAP_ITEM                                    = 0x399C,
    CMSG_SWAP_ITEM_WITH_GUILD_BANK_ITEM               = 0x34BD,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_TOY_UPDATE                           = 0x25C4,
    SMSG_ACCOUNT_TRANSMOG_SET_FAVORITES_UPDATE        = 0x25C7,
    SMSG_ACCOUNT_TRANSMOG_UPDATE                      = 0x25C6,
    ...
    SMSG_ADDON_LIST_REQUEST                           = 0x265F,
    ...
    SMSG_AUCTION_LIST_BIDDED_ITEMS_RESULT             = 0x272C,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x272A,
    SMSG_AUCTION_LIST_OWNED_ITEMS_RESULT              = 0x272B,
    ...
    SMSG_BAG_CLEANUP_FINISHED                         = 0x2824,
    SMSG_BAN_REASON                                   = 0x26B2,
    SMSG_BARBER_SHOP_RESULT                           = 0x26E8,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x2844,
    ...
    SMSG_CALENDAR_COMMUNITY_INVITE                    = 0x26B6,
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x26BE,
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x26BF,
    SMSG_CALENDAR_INVITE_ADDED                        = 0x26B7,
    SMSG_CALENDAR_INVITE_ALERT                        = 0x26B8,
    SMSG_CALENDAR_INVITE_NOTES                        = 0x26C0,
    SMSG_CALENDAR_INVITE_NOTES_ALERT                  = 0x26C1,
    SMSG_CALENDAR_INVITE_REMOVED                      = 0x26BC,
    SMSG_CALENDAR_INVITE_REMOVED_ALERT                = 0x26BD,
    SMSG_CALENDAR_INVITE_STATUS                       = 0x26B9,
    SMSG_CALENDAR_INVITE_STATUS_ALERT                 = 0x26BA,
    SMSG_CALENDAR_MODERATOR_STATUS                    = 0x26BB,
    ...
    SMSG_COMMERCE_TOKEN_GET_LOG_RESPONSE              = 0x2823,
    SMSG_COMMERCE_TOKEN_GET_MARKET_PRICE_RESPONSE     = 0x2819,
    ...
    SMSG_GARRISON_MAP_DATA_RESPONSE                   = 0x292C,
    ...
    SMSG_INVENTORY_FULL_OVERFLOW                      = 0x2863,
    ...
    SMSG_LEARN_PVP_TALENT_FAILED                      = 0x25EA,
    SMSG_LEARN_TALENT_FAILED                          = 0x25E9,
    ...
    SMSG_OPEN_ARTIFACT_FORGE                          = 0x27E2,
    ...
    SMSG_PARTY_MEMBER_FULL_STATE                      = 0x279B,
    ...
    SMSG_PVP_MATCH_STATISTICS                         = 0x25B3,
    ...
    SMSG_RECRUIT_A_FRIEND_FAILURE                     = 0x26EB,
    ...
    SMSG_REQUEST_SCHEDULED_PVP_INFO_RESPONSE          = 0x25D5,
    ...
    SMSG_SERVER_TIME_OFFSET                           = 0x2753,
    ...
    SMSG_SOCKET_GEMS_SUCCESS                          = 0x2768,
    ...
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26CE,
    SMSG_WORLD_QUEST_UPDATE_RESPONSE                  = 0x2847,
