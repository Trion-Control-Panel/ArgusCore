...
class TC_GAME_API WorldSession
{
    public:
        ...
        /**
         * @fn  void WorldSession::SendAuctionCommandResult(uint32 auctionId, uint32 action, uint32 errorCode, uint32 bidError = 0);
         *
    ...
    public:                                                 // opcodes handlers
        ...
        bool ValidateAppearance(Races race, Classes playerClass, Gender gender, uint8 hairID, uint8 hairColor, uint8 faceID, uint8 facialHair, uint8 skinColor, std::array<uint8, PLAYER_CUSTOM_DISPLAY_SIZE> const& customDisplay, bool create = false);
        ...
        void HandleAuctionListItems(WorldPackets::AuctionHouse::AuctionListItems& listItems);
        ...
        void HandleAuctionListOwnerItems(WorldPackets::AuctionHouse::AuctionListOwnedItems& listOwnerItems);
        ...
        ChatMessageResult HandleChatMessage(ChatMsg type, Language lang, std::string msg, std::string target = "");
        ...
        void HandleCalendarGuildFilter(WorldPackets::Calendar::CalendarCommunityInviteRequest& calendarGuildFilter);
        ...
        void HandleGarrisonGetMapData(WorldPackets::Garrison::GarrisonGetMapData& garrisonGetBuildingLandmarks);
        void HandleGarrisonRequestScoutingMap(WorldPackets::Garrison::GarrisonRequestScoutingMap& garrisonRequestScoutingMap);
