...
ByteBuffer& operator<<(ByteBuffer& data, PVPMatchStatistics::PlayerData const& playerData)
{
    ...
    data << Bits<1>(playerData.Faction != 0);
...
WorldPacket const* PVPMatchStatistics::Write()
{
