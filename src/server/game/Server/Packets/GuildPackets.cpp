...
WorldPacket const* GuildRoster::Write()
{
    ...
    _worldPacket << SizedString::BitsSize<10>(WelcomeText);
...
WorldPacket const* GuildRosterUpdate::Write()
{
    _worldPacket << Size<uint32>(MemberData);
...
{
    _worldPacket >> SizedString::BitsSize<10>(MotdText);
