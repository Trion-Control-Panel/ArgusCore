...
namespace WorldPackets
{
    namespace Battleground
    {
        ...
        {
        public:
            explicit SeasonInfo() : ServerPacket(SMSG_SEASON_INFO, 8) { }
        ...
        {
        public:
            explicit PVPMatchStatistics() : ServerPacket(SMSG_PVP_MATCH_STATISTICS, 0) { }
        ...
        {
        public:
            explicit RatedPvpInfo() : ServerPacket(SMSG_RATED_PVP_INFO, 6 * sizeof(BracketInfo)) { }
            WorldPacket const* Write() override;
            struct BracketInfo
            {
