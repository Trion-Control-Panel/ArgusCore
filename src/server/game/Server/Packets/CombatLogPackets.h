...
namespace WorldPackets
{
    namespace CombatLog
    {
        ...
        {
        public:
            explicit SpellHealLog() : CombatLogServerPacket(SMSG_SPELL_HEAL_LOG, 16 + 16 + 4 * 4 + 1) { }
        ...
        {
            explicit SpellLogMissEntry(ObjectGuid const& victim, uint8 missReason) : Victim(victim), MissReason(missReason) { }
