...
void PhasingHandler::SendToPlayer(Player const* player, PhaseShift const& phaseShift)
{
    ...
    phaseShiftChange.UiWorldMapAreaIDSwaps.resize(phaseShift.UiWorldMapAreaIdSwaps.size());
    std::ranges::transform(phaseShift.UiWorldMapAreaIdSwaps, phaseShiftChange.UiWorldMapAreaIDSwaps.begin(),Trinity::Containers::MapKey);
