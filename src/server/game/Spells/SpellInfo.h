...
class TC_GAME_API SpellInfo
{
    ...
    public:
        ...
        explicit SpellInfo(SpellEntry const* spellEntry, ::Difficulty difficulty, SpellInfoLoadHelper const& data);
        explicit SpellInfo(SpellEntry const* spellEntry, ::Difficulty difficulty, std::vector<SpellEffectEntry> const& effects);
