...
namespace Trinity
{
    ...
    public:
        ...
        ChatPacketSender(ChatMsg chatType, ::Language language, WorldObject const* sender, WorldObject const* receiver, std::string message,
            uint32 achievementId = 0, LocaleConstant locale = LOCALE_enUS, uint16 emoteId = 0, uint32 soundKitId = 0, SoundKitPlayType soundKitPlayType = SoundKitPlayType::Normal, uint32 playerConditionId = 0);
