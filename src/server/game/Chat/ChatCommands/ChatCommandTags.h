...
namespace Trinity::Impl::ChatCommands
{
    ...
    TC_GAME_API ChatCommandResult TryConsumeExactSequence(std::string_view sequence, ChatHandler const* handler, std::string_view args);
}
...
namespace Trinity::ChatCommands
{
    ...
    struct ExactSequence : Trinity::Impl::ChatCommands::ContainerTag
    {
        ...
        {
            return Trinity::Impl::ChatCommands::TryConsumeExactSequence(Sequence, handler, args);
        }
    };
