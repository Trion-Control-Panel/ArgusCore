...
#define QUEST_TEMPLATE_FIELDS (ID)(QuestType)(QuestLevel)(MaxScalingLevel)(QuestPackageID)(MinLevel)(QuestSortID)(QuestInfoID)(SuggestedGroupNum)(RewardNextQuest)(RewardXPDifficulty)\
    ...
    (RewardCurrencyID4)(RewardCurrencyQty4)(AcceptedSoundKitID)(CompleteSoundKitID)(AreaGroupID)(TimeAllowed)(AllowableRaces)(TreasurePickerID)(Expansion)\
    (LogTitle)(LogDescription)(QuestDescription)(AreaDescription)(PortraitGiverText)(PortraitGiverName)\
...
Quest::Quest(QuestTemplateQueryResult const& questRecord) :
    ...
    _treasurePickerID(questRecord.TreasurePickerID().GetInt32()),
...
void Quest::LoadRewardDisplaySpell(Field* fields)
{
    ...
    if (!added)
        TC_LOG_ERROR("sql.sql", "Table `quest_reward_display_spell` has more than three records for quest {}; ignoring spell {}", fields[0].GetUInt32(), spellId);
}
...
{
    uint32 value = 0;
    if (QuestMoneyRewardEntry const* money = sQuestMoneyRewardStore.LookupEntry(GetQuestMaxScalingLevel()))
