...
public:
    ...
    static bool HandleDebugPlayObjectSoundCommand(ChatHandler* handler, int32 soundKitId)
    {
        ...
        player->PlayObjectSound(soundKitId, player->GetGUID(), player);
    ...
    static bool HandleDebugSendSetPhaseShiftCommand(ChatHandler* handler, Optional<uint32> phaseId, Optional<uint32> visibleMapId, Optional<uint32> uiMapAreaIdSwap)
    {
        ...
        if (uiMapAreaIdSwap)
            phaseShift.AddUiWorldMapAreaIdSwap(*uiMapAreaIdSwap);
