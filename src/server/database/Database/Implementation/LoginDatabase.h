...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_BATTLEPAY_BALANCE,
    LOGIN_UPD_BATTLEPAY_BALANCE_DEDUCT,
    LOGIN_INS_BATTLEPAY_BALANCE_CREDIT,
    LOGIN_SEL_BATTLENET_ACCOUNT_BY_ACCOUNT_ID,

    // BattlePay Character Boost credits - see ARGUSCORE_FIXES.md
    LOGIN_SEL_BATTLEPAY_PENDING_BOOST_LIST,
    LOGIN_SEL_BATTLEPAY_PENDING_BOOST_BY_DISTRIBUTION,
    LOGIN_UPD_BATTLEPAY_PENDING_BOOST_REDEEMED,
    LOGIN_INS_BATTLEPAY_PENDING_BOOST,
