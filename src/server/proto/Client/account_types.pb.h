...
class TC_PROTO_API CAIS : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_last_heard_time() const PROTOBUF_DEPRECATED;
  inline void clear_last_heard_time() PROTOBUF_DEPRECATED;
  static const int kLastHeardTimeFieldNumber = 3;
  inline ::google::protobuf::uint64 last_heard_time() const PROTOBUF_DEPRECATED;
  inline void set_last_heard_time(::google::protobuf::uint64 value) PROTOBUF_DEPRECATED;
