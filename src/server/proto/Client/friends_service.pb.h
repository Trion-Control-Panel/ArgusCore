...
class TC_PROTO_API SetAttributeRequest : public ::google::protobuf::Message {
 public:
  SetAttributeRequest();
  virtual ~SetAttributeRequest();

  SetAttributeRequest(const SetAttributeRequest& from);

  inline SetAttributeRequest& operator=(const SetAttributeRequest& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SetAttributeRequest& default_instance();

  void Swap(SetAttributeRequest* other);

  // implements Message ----------------------------------------------

  SetAttributeRequest* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SetAttributeRequest& from);
  void MergeFrom(const SetAttributeRequest& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:bgs.protocol.friends.v1.SetAttributeRequest)
 private:
  inline void set_has_agent_id();
  inline void clear_has_agent_id();
  inline void set_has_target_id();
  ...
  void InitAsDefaultInstance();
  static SetAttributeRequest* default_instance_;
};
// -------------------------------------------------------------------
...
class TC_PROTO_API FriendsService : public ServiceBase
{
 ...
 protected:
  ...
  virtual uint32 HandleSetAttribute(::bgs::protocol::friends::v1::SetAttributeRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation);
 ...
 private:
  ...
  void ParseAndHandleSetAttribute(uint32 token, uint32 methodId, MessageBuffer& buffer);
};
...
// optional .bgs.protocol.account.v1.AccountId agent_id = 1;
inline bool SetAttributeRequest::has_agent_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SetAttributeRequest::set_has_agent_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SetAttributeRequest::clear_has_agent_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SetAttributeRequest::clear_agent_id() {
  if (agent_id_ != NULL) agent_id_->::bgs::protocol::account::v1::AccountId::Clear();
  clear_has_agent_id();
}
inline const ::bgs::protocol::account::v1::AccountId& SetAttributeRequest::agent_id() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.friends.v1.SetAttributeRequest.agent_id)
  return agent_id_ != NULL ? *agent_id_ : *default_instance_->agent_id_;
}
inline ::bgs::protocol::account::v1::AccountId* SetAttributeRequest::mutable_agent_id() {
  set_has_agent_id();
  if (agent_id_ == NULL) agent_id_ = new ::bgs::protocol::account::v1::AccountId;
  // @@protoc_insertion_point(field_mutable:bgs.protocol.friends.v1.SetAttributeRequest.agent_id)
  return agent_id_;
}
inline ::bgs::protocol::account::v1::AccountId* SetAttributeRequest::release_agent_id() {
  clear_has_agent_id();
  ::bgs::protocol::account::v1::AccountId* temp = agent_id_;
  agent_id_ = NULL;
  return temp;
}
inline void SetAttributeRequest::set_allocated_agent_id(::bgs::protocol::account::v1::AccountId* agent_id) {
  delete agent_id_;
  agent_id_ = agent_id;
  if (agent_id) {
    set_has_agent_id();
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.friends.v1.SetAttributeRequest.agent_id)
}

// optional .bgs.protocol.account.v1.AccountId target_id = 2;
inline bool SetAttributeRequest::has_target_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void SetAttributeRequest::set_has_target_id() {
  _has_bits_[0] |= 0x00000002u;
}
inline void SetAttributeRequest::clear_has_target_id() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void SetAttributeRequest::clear_target_id() {
  if (target_id_ != NULL) target_id_->::bgs::protocol::account::v1::AccountId::Clear();
  clear_has_target_id();
}
inline const ::bgs::protocol::account::v1::AccountId& SetAttributeRequest::target_id() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.friends.v1.SetAttributeRequest.target_id)
  return target_id_ != NULL ? *target_id_ : *default_instance_->target_id_;
}
inline ::bgs::protocol::account::v1::AccountId* SetAttributeRequest::mutable_target_id() {
  set_has_target_id();
  if (target_id_ == NULL) target_id_ = new ::bgs::protocol::account::v1::AccountId;
  // @@protoc_insertion_point(field_mutable:bgs.protocol.friends.v1.SetAttributeRequest.target_id)
  return target_id_;
}
inline ::bgs::protocol::account::v1::AccountId* SetAttributeRequest::release_target_id() {
  clear_has_target_id();
  ::bgs::protocol::account::v1::AccountId* temp = target_id_;
  target_id_ = NULL;
  return temp;
}
inline void SetAttributeRequest::set_allocated_target_id(::bgs::protocol::account::v1::AccountId* target_id) {
  delete target_id_;
  target_id_ = target_id;
  if (target_id) {
    set_has_target_id();
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.friends.v1.SetAttributeRequest.target_id)
}

// repeated .bgs.protocol.Attribute attribute = 3;
inline int SetAttributeRequest::attribute_size() const {
  return attribute_.size();
}
inline void SetAttributeRequest::clear_attribute() {
  attribute_.Clear();
}
inline const ::bgs::protocol::Attribute& SetAttributeRequest::attribute(int index) const {
  // @@protoc_insertion_point(field_get:bgs.protocol.friends.v1.SetAttributeRequest.attribute)
  return attribute_.Get(index);
}
inline ::bgs::protocol::Attribute* SetAttributeRequest::mutable_attribute(int index) {
  // @@protoc_insertion_point(field_mutable:bgs.protocol.friends.v1.SetAttributeRequest.attribute)
  return attribute_.Mutable(index);
}
inline ::bgs::protocol::Attribute* SetAttributeRequest::add_attribute() {
  // @@protoc_insertion_point(field_add:bgs.protocol.friends.v1.SetAttributeRequest.attribute)
  return attribute_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::bgs::protocol::Attribute >&
SetAttributeRequest::attribute() const {
  // @@protoc_insertion_point(field_list:bgs.protocol.friends.v1.SetAttributeRequest.attribute)
  return attribute_;
}
inline ::google::protobuf::RepeatedPtrField< ::bgs::protocol::Attribute >*
SetAttributeRequest::mutable_attribute() {
  // @@protoc_insertion_point(field_mutable_list:bgs.protocol.friends.v1.SetAttributeRequest.attribute)
  return &attribute_;
}
