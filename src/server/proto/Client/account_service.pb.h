...
class TC_PROTO_API AccountService : public ServiceBase
{
 ...
 private:
  ...
  void ParseAndHandleIsIgrAddress(uint32 token, uint32 methodId, MessageBuffer& buffer);
  ...
  void ParseAndHandleGameAccountFlagUpdate(uint32 token, uint32 methodId, MessageBuffer& buffer);
};
