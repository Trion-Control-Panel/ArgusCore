...
class TC_PROTO_API PresenceService : public ServiceBase
{
 ...
 private:
  ...
  void ParseAndHandleOwnership(uint32 token, uint32 methodId, MessageBuffer& buffer);
  void ParseAndHandleSubscribeNotification(uint32 token, uint32 methodId, MessageBuffer& buffer);
};
