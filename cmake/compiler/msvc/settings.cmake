...
if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS MSVC_EXPECTED_VERSION)
    message(FATAL_ERROR "MSVC: ArgusCore requires version ${MSVC_EXPECTED_VERSION} (${MSVC_EXPECTED_VERSION_STRING}) to build but found ${CMAKE_CXX_COMPILER_VERSION}")
  else()
...
# Disable incremental linking in debug builds to prevent linking getting stuck.
# CMake injects /INCREMENTAL by default; we strip it then add /INCREMENTAL:NO explicitly.
foreach(_flag_var
    CMAKE_EXE_LINKER_FLAGS_DEBUG
    CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO
    CMAKE_SHARED_LINKER_FLAGS_DEBUG
    CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO)
  string(REGEX REPLACE "/INCREMENTAL *" "" ${_flag_var} "${${_flag_var}}")
  string(APPEND ${_flag_var} " /INCREMENTAL:NO")
endforeach()
