...
# We use a configs/ subfolder under the install prefix so the layout is
# the same on all platforms: binary next to a configs/ folder. Previously
# this was the FHS-style etc/, but that split the binary from its configs.
if(NOT CONF_DIR)
  set(CONF_DIR ${CMAKE_INSTALL_PREFIX}/configs CACHE PATH "Configuration directory")
