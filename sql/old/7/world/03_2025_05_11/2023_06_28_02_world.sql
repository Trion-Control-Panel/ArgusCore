...
UPDATE `gameobject_template` SET `Data1`=0, `Data30`=18676, `VerifiedBuild`=49801 WHERE `entry`=182031; -- Discarded Nutriment
# UPDATE `gameobject_template` SET `ContentTuningId`=38, `VerifiedBuild`=49801 WHERE `entry` IN (183284, 182115); -- Wanted Poster
UPDATE `gameobject_template` SET `Data1`=0, `Data2`=1, `Data30`=18793, `VerifiedBuild`=49801 WHERE `entry`=182166; -- Ango'rosh Attack Plans
UPDATE `gameobject_template` SET `Data1`=0, `Data30`=19430, `VerifiedBuild`=49801 WHERE `entry`=182600; -- Marshberry
UPDATE `gameobject_template` SET `Data8`=103829, `Data10`=30092, `VerifiedBuild`=49801 WHERE `entry`=183818; -- Forge
UPDATE `gameobject_template` SET `Data1`=0, `Data2`=1, `Data30`=19098, `VerifiedBuild`=49801 WHERE `entry`=182184; -- Daggerfen Poison Manual
UPDATE `gameobject_template` SET `Data8`=103828, `Data10`=30091, `VerifiedBuild`=49801 WHERE `entry`=183795; -- Anvil
UPDATE `gameobject_template` SET `Data1`=0, `Data30`=18700, `VerifiedBuild`=49801 WHERE `entry`=182069; -- Mature Spore Sac
UPDATE `gameobject_template` SET `Data1`=0, `Data30`=19099, `VerifiedBuild`=49801 WHERE `entry`=182185; -- Daggerfen Poison Vial
UPDATE `gameobject_template` SET `Data1`=0, `Data30`=19433, `VerifiedBuild`=49801 WHERE `entry`=182050; -- Box of Mushrooms
