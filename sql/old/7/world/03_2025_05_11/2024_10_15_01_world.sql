...
UPDATE `gossip_menu_option` SET `OptionBroadcastTextID`=35051, `VerifiedBuild`=56819 WHERE (`MenuID`=10567 AND `OptionID`=1);
UPDATE `gossip_menu_option` SET `OptionBroadcastTextID`=35050, `ActionMenuID`=10568, `VerifiedBuild`=56819 WHERE (`MenuID`=10567 AND `OptionID`=0);
