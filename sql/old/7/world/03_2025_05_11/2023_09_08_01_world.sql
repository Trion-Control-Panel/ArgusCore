...
-- Gossip
UPDATE `gossip_menu_option` SET `ActionMenuID`=18993, `VerifiedBuild`=51237 WHERE (`MenuID`=18864 AND `OptionID`=0);
UPDATE `gossip_menu_option` SET `OptionBroadcastTextId`=11964, `ActionMenuID`=18864, `VerifiedBuild`=51237 WHERE (`MenuID`=18993 AND `OptionID`=0); -- OptionBroadcastTextID: 11964 - 101473
