...
-- Creature Template
UPDATE `creature_template` SET `gossip_menu_id`=16967 WHERE `entry`=85519; -- Christoph VonFeasel
UPDATE `creature_template` SET `gossip_menu_id`=15172 WHERE `entry`=67370; -- Jeremy Feasel
...
(16967, 0, 0, 'I challenge you to a pet battle! |cFF0008E8(Darkmoon Game Token)|r', 68908, 0, 0, 0, 0, NULL, 0, 47213),
(15172, 0, 0, 'I challenge you to a pet battle! |cFF0008E8(Darkmoon Game Token)|r', 68908, 0, 0, 0, 0, NULL, 0, 47213);
