...
UPDATE `gameobject_template` SET `Data1`=0, `Data10`=1, `Data12`=1, `Data15`=0, `Data25`=1094, `Data30`=88624, `VerifiedBuild`=54904 WHERE `entry`=193905; -- Alexstrasza's Gift
UPDATE `gameobject_template` SET `Data1`=0, `Data15`=0, `Data25`=1094, `Data30`=26859, `VerifiedBuild`=54904 WHERE `entry`=194158; -- Heart of Magic
UPDATE `gameobject_template` SET `Data26`=1, `VerifiedBuild`=54904 WHERE `entry`=193908; -- Exit Portal
...
UPDATE `gameobject_template` SET `Data1`=0, `Data10`=1, `Data12`=1, `Data15`=0, `Data25`=1094, `Data30`=88632, `VerifiedBuild`=54904 WHERE `entry`=193967; -- Alexstrasza's Gift
UPDATE `gameobject_template` SET `Data1`=0, `Data15`=0, `Data25`=1094, `Data30`=26860, `VerifiedBuild`=54904 WHERE `entry`=194159; -- Heart of Magic
