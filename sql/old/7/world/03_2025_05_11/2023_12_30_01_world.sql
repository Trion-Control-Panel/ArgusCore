...
CREATE PROCEDURE areatrigger_refactor() BEGIN
  ...
  INSERT INTO `areatrigger_create_properties` (`Id`, `IsCustom`, `AreaTriggerId`, `IsAreatriggerCustom`, `Shape`, `ShapeData0`, `ShapeData1`, `ShapeData2`, `ShapeData3`, `ShapeData4`, `ShapeData5`) VALUES
  (@CPC_ID+0, 1, 1, 1, 1, 3, 1, 3, 3, 1, 3),
  (@CPC_ID+1, 1, 2, 1, 1, 1.25977, 1.27927, 3.70216, 1.25977, 1.27927, 3.70216),
  (@CPC_ID+2, 1, 3, 1, 4, 4, 4, 6, 6, 0, 0),
  (@CPC_ID+3, 1, 4, 1, 4, 0.5, 0.5, 3, 3, 0, 0),
  (@CPC_ID+4, 1, 5, 1, 4, 40, 40, 10, 10, 0, 0),
  (@CPC_ID+5, 1, 6, 1, 4, 0.5, 0.5, 3, 3, 0, 0),
  (@CPC_ID+6, 1, 7, 1, 4, 3, 3, 5, 5, 0, 0),
  (@CPC_ID+7, 1, 8, 1, 4, 4, 4, 4, 4, 0, 0),
  (@CPC_ID+8, 1, 9, 1, 4, 4, 4, 7, 7, 0, 0),
  (@CPC_ID+9, 1, 10, 1, 4, 5, 5, 5, 5, 0, 0),
  (@CPC_ID+10, 1, 11, 1, 4, 4, 4, 15, 15, 0, 0),
  (@CPC_ID+11, 1, 12, 1, 4, 4, 4, 5, 5, 0, 0),
  (@CPC_ID+12, 1, 13, 1, 4, 4, 4, 5, 5, 0, 0),
  (@CPC_ID+13, 1, 14, 1, 4, 4, 4, 5, 5, 0, 0),
  (@CPC_ID+14, 1, 15, 1, 4, 4, 4, 5, 5, 0, 0),
  (@CPC_ID+15, 1, 16, 1, 4, 4, 4, 5, 5, 0, 0),
  (@CPC_ID+16, 1, 17, 1, 4, 5, 5, 8, 8, 0, 0),
  (@CPC_ID+17, 1, 18, 1, 4, 5, 5, 8, 8, 0, 0),
  (@CPC_ID+18, 1, 19, 1, 4, 5, 5, 9, 9, 0, 0),
  (@CPC_ID+19, 1, 20, 1, 6, 5, 5, 8, 8, 0, 0),
  (@CPC_ID+20, 1, 21, 1, 4, 5, 5, 6, 6, 0, 0),
  (@CPC_ID+21, 1, 22, 1, 4, 5, 5, 8, 8, 0, 0),
  (@CPC_ID+22, 1, 23, 1, 1, 18, 18, 12, 18, 18, 12),
  (@CPC_ID+23, 1, 24, 1, 1, 2, 50, 30, 2, 50, 30),
  (@CPC_ID+24, 1, 25, 1, 1, 1, 25, 80, 1, 25, 80),
  (@CPC_ID+25, 1, 26, 1, 1, 1, 20, 30, 1, 20, 30),
  (@CPC_ID+26, 1, 27, 1, 1, 20, 50, 5, 20, 50, 5),
  (@CPC_ID+27, 1, 28, 1, 1, 10, 25, 1, 10, 25, 1),
  (@CPC_ID+28, 1, 29, 1, 0, 3, 3, 0, 0, 0, 0),
  (@CPC_ID+29, 1, 30, 1, 0, 5, 5, 0, 0, 0, 0),
  (@CPC_ID+30, 1, 31, 1, 0, 5, 5, 0, 0, 0, 0),
  (@CPC_ID+31, 1, 32, 1, 1, 38, 38, 25, 38, 38, 25),
  (@CPC_ID+32, 1, 33, 1, 0, 1.5, 1.5, 0, 0, 0, 0),
  (@CPC_ID+33, 1, 44, 1, 1, 30, 20, 10, 30, 20, 10),
  (@CPC_ID+34, 1, 45, 1, 1, 250, 250, 50, 250, 250, 50),
  (@CPC_ID+35, 1, 46, 1, 0, 75, 75, 0, 0, 0, 0),
  (@CPC_ID+36, 1, 48, 1, 1, 35, 20, 25, 35, 20, 25),
  (@CPC_ID+37, 1, 49, 1, 1, 30, 50, 5, 30, 50, 5),
  (@CPC_ID+38, 1, 51, 1, 0, 70, 70, 0, 0, 0, 0),
  (@CPC_ID+39, 1, 52, 1, 1, 20, 20, 10, 20, 20, 10),
  (@CPC_ID+40, 1, 53, 1, 1, 30, 20, 10, 30, 20, 10),
  (@CPC_ID+41, 1, 54, 1, 1, 4, 60, 30, 4, 60, 30),
  (@CPC_ID+42, 1, 17635, 0, 4, 40, 40, 10, 10, 0, 0);
