...
-- Gossip
UPDATE `gossip_menu_option` SET `BoxText`='You are about to embark on a dangerous mission, and you may not be able to return immediately. Are you sure?', `BoxBroadcastTextID`= 88773, `VerifiedBuild`=50791 WHERE (`MenuID`=16863 AND `OptionID`=0);
