...
-- Creature templates
UPDATE `creature_template` SET `gossip_menu_id`=5181 WHERE `entry`=13429; -- Nardstrum Copperpinch
UPDATE `creature_template` SET `gossip_menu_id`=5181 WHERE `entry`=13430; -- Jaycrue Copperpinch
UPDATE `creature_template` SET `gossip_menu_id`=6813, `faction`=775, `speed_walk`=1, `npcflag`=1, `unit_flags`=32768 WHERE `entry` IN (15788, 15790); -- Undead Winter Reveler
