...
-- Creature templates
UPDATE `creature_template` SET `gossip_menu_id`=6813, `faction`=774, `speed_walk`=1, `npcflag`=1, `unit_flags`=32768 WHERE `entry` IN (15784, 15794); -- Night Elf Winter Reveler
