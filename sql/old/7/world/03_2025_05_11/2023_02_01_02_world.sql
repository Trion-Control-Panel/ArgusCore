...
UPDATE `creature_template` SET `speed_run`=1, `unit_flags`=33554432, `unit_flags3`=524289 WHERE `entry`=54519; -- Winter Veil Tree
UPDATE `creature_template` SET `unit_flags`=33554432, `unit_flags2`=32768, `unit_flags3`=524289 WHERE `entry`=54523; -- Strange Snowman
