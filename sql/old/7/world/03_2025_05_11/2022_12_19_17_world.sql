...
UPDATE `creature_template` SET `gossip_menu_id`=6813, `faction`=774, `speed_walk`=1, `npcflag`=1, `unit_flags`=32768 WHERE `entry` IN (15782, 15783); -- Dwarf Winter Reveler
UPDATE `creature_template` SET `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=110441; -- Snowglobe Stalker
UPDATE `creature_template` SET `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=123745; -- Snowglobe Stalker 2
UPDATE `creature_template` SET `unit_flags3`=16777216 WHERE `entry`=158558; -- Red-Nosed Reindeer
UPDATE `creature_template` SET `unit_flags3`=16777216 WHERE `entry`=158559; -- Great Reindeer
UPDATE `creature_template` SET `unit_flags3`=16777217 WHERE `entry`=158560; -- Great Reindeer
UPDATE `creature_template` SET `npcflag`=16777216, `unit_flags3`=16777217 WHERE `entry`=158561; -- Greatfather Winter's Sleigh
...
(6769, 0, 1, 'Let me browse your seasonal fare.', 8786, 0, 0, 0, 0, NULL, 0, 47187); -- OptionBroadcastTextID: 8786 - 98021
