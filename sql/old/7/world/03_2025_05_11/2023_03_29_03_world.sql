-- Creature Template
UPDATE `creature_template` SET `npcflag`=16777216, `speed_run`=1.142857193946838378 WHERE `entry`=43044; -- Unexploded Artillery Shell
UPDATE `creature_template` SET `npcflag`=16777216, `unit_flags3`=16777216 WHERE `entry`=43046; -- Unexploded Artillery Shell Mount
UPDATE `creature_template` SET `npcflag`=16777216, `unit_flags3`=8192, `dynamicflags`=0 WHERE `entry`=43032; -- Slain Cannoneer
UPDATE `creature_template` SET `npcflag`=16777216, `unit_flags3`=8192, `dynamicflags`=0 WHERE `entry`=43048; -- Captain Skullshatter
...
(26245, 0, 4, 32, 0, 0, 646, 640, 0, 0, 0, 0, 429240, 0, 48676),         -- Gunship Down
(26245, 0, 3, 2, 265267, 43029, 646, 640, 0, 0, 0, 0, 0, 0, 48676),      -- Gunship Down
(26245, 0, 2, 1, 265266, 43028, 646, 640, 0, 0, 0, 0, 429083, 0, 48676), -- Gunship Down
(26245, 0, 1, 0, 265265, 43027, 646, 640, 0, 0, 0, 0, 429119, 0, 48676), -- Gunship Down
(26245, 0, 0, -1, 0, 0, 646, 640, 0, 0, 0, 0, 0, 0, 48676); -- Gunship Down
...
(26245, 4, 0, 996, 521, 48676), -- Gunship Down
(26245, 3, 0, 220, 170, 48676), -- Gunship Down
(26245, 2, 0, 274, 192, 48676), -- Gunship Down
(26245, 1, 0, 288, 322, 48676), -- Gunship Down
(26245, 0, 0, 996, 521, 48676); -- Gunship Down
