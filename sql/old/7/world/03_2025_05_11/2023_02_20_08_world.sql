...
-- Creature templates
UPDATE `creature_template` SET `unit_flags`=32768 WHERE `entry`=40438; -- Steamwheedle Shyster
...
UPDATE `creature_template` SET `unit_flags`=512 WHERE `entry` IN (38339, 38338, 38337); -- Snivel Rustrocket
...
UPDATE `creature_template` SET `unit_flags`=512 WHERE `entry`=37715; -- Snivel Rustrocket
...
UPDATE `creature_template` SET `unit_flags`=32768 WHERE `entry`=37671; -- Crown Supply Guard
# UPDATE `creature_template` SET `minlevel`=70, `maxlevel`=70 WHERE `entry`=37172; -- Detective Snap Snagglebolt
UPDATE `creature_template` SET `speed_run`=0.857142865657806396, `unit_flags`=768 WHERE `entry`=16085; -- Peddlefeet
...
UPDATE `gossip_menu_option` SET `OptionBroadcastTextId`=40429, `VerifiedBuild`=48069 WHERE (`MenuID`=10976 AND `OptionID`=1);
