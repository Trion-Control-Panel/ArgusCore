...
UPDATE `creature_template` SET `gossip_menu_id`=10569 WHERE `entry`=34712; -- Roberta Carter
UPDATE `creature_template` SET `gossip_menu_id`=10571, `npcflag`=3 WHERE `entry`=34768; -- William Mullins
