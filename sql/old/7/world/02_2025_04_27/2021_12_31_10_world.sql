...
ALTER TABLE areatrigger_create_properties_orbit ENGINE=InnoDB ROW_FORMAT=DEFAULT;
...
ALTER TABLE battle_pet_breeds ENGINE=InnoDB ROW_FORMAT=DEFAULT;
ALTER TABLE battle_pet_quality ENGINE=InnoDB ROW_FORMAT=DEFAULT;
...
ALTER TABLE bfa_map_conversion ENGINE=InnoDB ROW_FORMAT=DEFAULT;
...
ALTER TABLE creature_template_scaling ENGINE=InnoDB ROW_FORMAT=DEFAULT;
