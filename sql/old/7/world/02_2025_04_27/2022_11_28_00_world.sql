...
UPDATE `creature_template` SET `gossip_menu_id`=17416, `VerifiedBuild`=46549 WHERE `entry`=88908; -- Boss Whalebelly
...
UPDATE `creature_template` SET `gossip_menu_id`=17417, `faction`=2136, `npcflag`=1, `BaseAttackTime`=2000, `unit_flags`=33600, `unit_flags2`=2048, `VerifiedBuild`=46549 WHERE `entry`=88916; -- Boss Whalebelly
