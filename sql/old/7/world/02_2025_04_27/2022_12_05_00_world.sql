...
UPDATE `creature_template` SET `gossip_menu_id`=10576 WHERE `entry`=34653; -- Bountiful Table Hostess
...
UPDATE `creature_template` SET `gossip_menu_id`=10569 WHERE `entry`=34710; -- Ellen Moore
UPDATE `creature_template` SET `gossip_menu_id`=10570 WHERE `entry`=34744; -- Jasper Moore
...
UPDATE `creature_template` SET `unit_flags`=2147746560 WHERE `entry`=35337; -- Bountiful Barrel
