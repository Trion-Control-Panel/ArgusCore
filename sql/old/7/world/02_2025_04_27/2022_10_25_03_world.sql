...
-- Creature templates
UPDATE `creature_template` SET `gossip_menu_id`=6589 WHERE `entry`=15353; -- Katrina Shimmerstar
...
(6589, 0, 1, 'What Hallow''s End candy do you have for sale?', 10815, 0, 0, 0, 0, NULL, 0, 45745),
(6589, 1, 0, 'What is there to do on Hallow''s End?', 10816, 6594, 0, 0, 0, NULL, 0, 45745);
