...
UPDATE `creature_template` SET `gossip_menu_id`= 18195, `npcflag`=3, `BaseAttackTime`=2000, `unit_flags`=33536, `unit_flags2`=2131968, `VerifiedBuild`=46366 WHERE `entry`=89978; -- Projection of Senegos
