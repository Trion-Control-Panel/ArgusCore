ALTER TABLE `areatrigger_template` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `areatrigger_template_polygon_vertices` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `conversation_actors` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `conversation_actor_template` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `conversation_line_template` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `conversation_template` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `spell_areatrigger` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `spell_areatrigger_circular` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `spell_areatrigger_splines` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
