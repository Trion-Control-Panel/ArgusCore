...
# INSERT INTO `creature_template_scaling` (`Entry`, `DifficultyID`, `LevelScalingDeltaMin`, `LevelScalingDeltaMax`, `VerifiedBuild`) VALUES
# (103672, 1, 0, 0, 46366),
# (102446, 1, 0, 0, 46366),
# (103561, 1, 0, 0, 46366),
# (112741, 1, 0, 0, 46366),
...
UPDATE `creature_template` SET `faction`=14, `speed_walk`=1.60000002384185791, `speed_run`=1.714285731315612792, `BaseAttackTime`=1500, `unit_flags`=768, `unit_flags2`=67160064, `unit_flags3`=18350080 WHERE `entry`=103672; -- Stasis Crystal
UPDATE `creature_template` SET `faction`=14, `speed_walk`=1.60000002384185791, `speed_run`=1.714285731315612792, `BaseAttackTime`=1500, `unit_flags`=64, `unit_flags2`=4196352 WHERE `entry`=102446; -- Fel Lord Betrug
UPDATE `creature_template` SET `faction`=14, `BaseAttackTime`=1000, `unit_flags`=32768, `unit_flags3`=524288 WHERE `entry`=103561; -- Shadow Beast
UPDATE `creature_template` SET `faction`=1720, `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=2048, `unit_flags3`=524288 WHERE `entry`=112741; -- Wrathguard Decimator
UPDATE `creature_template` SET `faction`=1720, `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=2048, `unit_flags3`=524288 WHERE `entry`=112739; -- Shadowy Overfiend
UPDATE `creature_template` SET `faction`=1720, `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=4196352, `unit_flags3`=524288 WHERE `entry`=102398; -- Blazing Infernal
UPDATE `creature_template` SET `speed_walk`=0.5, `speed_run`=0.571428596973419189, `unit_flags`=32768 WHERE `entry`=102372; -- Felhound Mage Slayer
UPDATE `creature_template` SET `faction`=14, `BaseAttackTime`=2000, `unit_flags`=33587200, `unit_flags3`=17301505 WHERE `entry`=103312; -- Soul Vortex
UPDATE `creature_template` SET `unit_flags`=32768 WHERE `entry`=102373; -- Corrosive Felhound
# UPDATE `creature_template` SET `minlevel`=45, `maxlevel`=45 WHERE `entry` IN (102335, 102337); -- Portal Guardian
UPDATE `creature_template` SET `faction`=16, `BaseAttackTime`=1500, `unit_flags`=33554496, `unit_flags2`=2048, `unit_flags3`=25690113 WHERE `entry`=102659; -- Blood-Princess Thal'ena
...
UPDATE `creature_template` SET `faction`=14, `BaseAttackTime`=2000, `unit_flags`=33587200, `unit_flags3`=17301504 WHERE `entry`=103146; -- Eyebomb
# UPDATE `creature_template` SET `minlevel`=45, `maxlevel`=45 WHERE `entry` IN (113610, 102282); -- Lord Malgath
UPDATE `creature_template` SET `faction`=1720, `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=4196352, `unit_flags3`=524288 WHERE `entry`=102397; -- Wrathlord Bulwark
UPDATE `creature_template` SET `faction`=1720, `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=4196352, `unit_flags3`=524288 WHERE `entry`=102400; -- Eredar Shadow Mender
UPDATE `creature_template` SET `faction`=1720, `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=4196352, `unit_flags3`=524288 WHERE `entry`=102395; -- Infiltrator Assassin
# UPDATE `creature_template` SET `minlevel`=45, `maxlevel`=45 WHERE `entry`=102369; -- Felstalker Ravener
UPDATE `creature_template` SET `faction`=14, `BaseAttackTime`=2000, `unit_flags`=33554432, `unit_flags2`=67143680, `unit_flags3`=17301505 WHERE `entry`=103450; -- Fel Axe
UPDATE `creature_template` SET `npcflag`=16777216, `BaseAttackTime`=1000000, `unit_flags`=33554432, `unit_flags2`=32, `unit_flags3`=1 WHERE `entry`=43499; -- Consecration
...
UPDATE `creature_template` SET `unit_flags`=0, `unit_flags2`=2048, `unit_flags3`=0 WHERE `entry`=102273; -- Doomguard Infiltrator
...
UPDATE `creature_template` SET `unit_flags`=33600, `unit_flags3`=1 WHERE `entry`=101951; -- Shivermaw
UPDATE `creature_template` SET `unit_flags`=33600, `unit_flags3`=1 WHERE `entry`=102431; -- Blood-Princess Thal'ena
# UPDATE `creature_template` SET `minlevel`=47, `maxlevel`=47 WHERE `entry`=101976; -- Millificent Manastorm
UPDATE `creature_template` SET `unit_flags`=33600 WHERE `entry`=102246; -- Anub'esset
# UPDATE `creature_template` SET `minlevel`=30, `maxlevel`=30 WHERE `entry`=32204; -- Lieutenant Sinclari
UPDATE `creature_template` SET `unit_flags`=0, `unit_flags2`=2048, `unit_flags3`=0 WHERE `entry`=102269; -- Felstalker Ravener
...
UPDATE `creature_template` SET `unit_flags`=570688256, `unit_flags2`=2049, `unit_flags3`=8192 WHERE `entry`=102270; -- Eredar Invader
UPDATE `creature_template` SET `unit_flags3`=16777217 WHERE `entry`=53488; -- Summon Enabler Stalker
UPDATE `creature_template` SET `gossip_menu_id`=19229, `npcflag`=1 WHERE `entry`=102278; -- Lieutenant Sinclari
# UPDATE `creature_template` SET `minlevel`=30, `maxlevel`=30 WHERE `entry`=30896; -- Prison Door Seal
UPDATE `creature_template` SET `unit_flags`=570688256, `unit_flags2`=2049, `unit_flags3`=8192 WHERE `entry`=102272; -- Felguard Destroyer
...
UPDATE `creature_template` SET `faction`=1718, `BaseAttackTime`=2000, `unit_flags`=570688320, `unit_flags2`=2049, `unit_flags3`=8192 WHERE `entry`=174272; -- Violet Hold Guard
UPDATE `creature_template` SET `unit_flags`=32768 WHERE `entry`=14881; -- Spider
UPDATE `creature_template` SET `unit_flags3`=16777216 WHERE `entry`=102671; -- Prison Cell
UPDATE `creature_template` SET `unit_flags`=80, `unit_flags2`=2048, `unit_flags3`=0 WHERE `entry`=102266; -- Violet Hold Guard
UPDATE `creature_template` SET `unit_flags3`=16777217 WHERE `entry`=92879; -- SLG Generic Stalker (Gigantic AOI)
UPDATE `creature_template` SET `unit_flags3`=16777217 WHERE `entry`=102489; -- Web Invisible Stalker
...
UPDATE `creature_template` SET `type_flags2`=128, `VerifiedBuild`=46597 WHERE `entry`=98542; -- Amalgam of Souls
UPDATE `creature_template` SET `HealthModifier`=0.75, `VerifiedBuild`=46597 WHERE `entry`=67231; -- Trial of the King
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=165737; -- Sinstone Statue
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=76227; -- Solar Flare
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=76283; -- Malefic Defender
UPDATE `creature_template` SET `type_flags2`=128, `VerifiedBuild`=46597 WHERE `entry`=98696; -- Illysanna Ravencrest
UPDATE `creature_template` SET `HealthModifier`=5, `VerifiedBuild`=46597 WHERE `entry`=161375; -- Promising Specimen
UPDATE `creature_template` SET `movementId`=84, `VerifiedBuild`=46597 WHERE `entry`=98761; -- Soul Fragment
UPDATE `creature_template` SET `HealthModifier`=7.5, `ManaModifier`=8.348600387573242187, `VerifiedBuild`=46597 WHERE `entry`=40634; -- Naz'jar Tempest Witch
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `HealthModifier`=6, `VerifiedBuild`=46597 WHERE `entry`=58605; -- Scarlet Judicator
UPDATE `creature_template` SET `type_flags2`=128, `VerifiedBuild`=46597 WHERE `entry`=98949; -- Smashspite the Hateful
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `VerifiedBuild`=46597 WHERE `entry`=58676; -- Scarlet Defender
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=76585; -- Ragewing the Untamed
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=152703; -- Walkie Shockie X1
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=76598; -- Ritual of Bones
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=139304; -- Solid Snake
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=130437; -- Mine Rat
UPDATE `creature_template` SET `HealthModifier`=1.5, `VerifiedBuild`=46597 WHERE `entry`=49864; -- Twilight Fiend
UPDATE `creature_template` SET `HealthModifier`=32, `VerifiedBuild`=46597 WHERE `entry`=27483; -- King Dred
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=76801; -- Ragewing Whelp
UPDATE `creature_template` SET `HealthModifier`=32, `VerifiedBuild`=46597 WHERE `entry`=99200; -- Dresaron
UPDATE `creature_template` SET `HealthModifier`=4.5, `movementId`=79, `VerifiedBuild`=46597 WHERE `entry`=36535; -- Corrupted Soul Fragment
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=81305; -- Fleshrender Nok'gar
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=170851; -- Volatile Plague Bomb
UPDATE `creature_template` SET `HealthModifier`=30, `VerifiedBuild`=46597 WHERE `entry`=27654; -- Drakos the Interrogator
UPDATE `creature_template` SET `HealthModifier`=250, `ManaModifier`=25, `movementId`=221, `VerifiedBuild`=46597 WHERE `entry`=27656; -- Ley-Guardian Eregos
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=32204; -- Lieutenant Sinclari
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `VerifiedBuild`=46597 WHERE `entry`=59080; -- Darkmaster Gandling
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=27756; -- Ruby Drake
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=77006; -- Corpse Skitterling
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `VerifiedBuild`=46597 WHERE `entry`=59100; -- Expired Test Subject
UPDATE `creature_template` SET `HealthModifier`=17.0859375, `VerifiedBuild`=46597 WHERE `entry`=126283; -- Urjad
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=162102; -- Grand Proctor Beryllia
UPDATE `creature_template` SET `HealthModifier`=31, `VerifiedBuild`=46597 WHERE `entry`=32273; -- Infinite Corruptor
UPDATE `creature_template` SET `type_flags2`=128, `VerifiedBuild`=46597 WHERE `entry`=94960; -- Hymdall
UPDATE `creature_template` SET `ManaModifier`=55.340301513671875, `VerifiedBuild`=46597 WHERE `entry`=139737; -- Lord Stormsong
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `VerifiedBuild`=46597 WHERE `entry`=59153; -- Rattlegore
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=153172; -- Stolen Scrapbot
UPDATE `creature_template` SET `HealthModifier`=50, `VerifiedBuild`=46597 WHERE `entry`=144246; -- K.U.-J.0.
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=153202; -- Piston Smasher
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=81603; -- Champion Druna
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=153245; -- Stolen Shock Coil
UPDATE `creature_template` SET `HealthModifier`=5, `VerifiedBuild`=46597 WHERE `entry`=50284; -- Twilight Zealot
UPDATE `creature_template` SET `HealthModifier`=1200, `ManaModifier`=140.399993896484375, `VerifiedBuild`=46597 WHERE `entry`=36855; -- Lady Deathwhisper
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=144311; -- Orb Guardian
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=27981; -- Malformed Ooze
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=162317; -- Gorechop
UPDATE `creature_template` SET `HealthModifier`=10, `VerifiedBuild`=46597 WHERE `entry`=41440; -- Aberration
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=99646; -- Gastropod
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=99663; -- Frustrated Soul
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=99664; -- Restless Soul
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=131009; -- Spirit of Gold
...
UPDATE `creature_template` SET `HealthModifier`=55, `ManaModifier`=50, `VerifiedBuild`=46597 WHERE `entry`=23574; -- Akil'zon
UPDATE `creature_template` SET `HealthModifier`=912, `VerifiedBuild`=46597 WHERE `entry`=45992; -- Valiona
UPDATE `creature_template` SET `HealthModifier`=912, `VerifiedBuild`=46597 WHERE `entry`=45993; -- Theralion
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=135552; -- Deathtouched Slaver
UPDATE `creature_template` SET `type_flags2`=128, `HealthModifier`=25, `VerifiedBuild`=46597 WHERE `entry`=104217; -- Talixae Flamewreath
UPDATE `creature_template` SET `HealthModifier`=0.375, `VerifiedBuild`=46597 WHERE `entry`=59458; -- Hopling
UPDATE `creature_template` SET `HealthModifier`=50, `VerifiedBuild`=46597 WHERE `entry`=59479; -- Yan-Zhu the Uncasked
UPDATE `creature_template` SET `HealthModifier`=1.447499990463256835, `VerifiedBuild`=46597 WHERE `entry`=104251; -- Duskwatch Sentry
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131140; -- Fatal Corruption
UPDATE `creature_template` SET `HealthScalingExpansion`=3, `HealthModifier`=0.144589006900787353, `VerifiedBuild`=46597 WHERE `entry`=50561; -- Bloodthirsty Ghoul
UPDATE `creature_template` SET `type_flags2`=128, `VerifiedBuild`=46597 WHERE `entry`=99868; -- Fenryr
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=99891; -- Storm Drake
...
UPDATE `creature_template` SET `HealthModifier`=54.6750030517578125, `VerifiedBuild`=46597 WHERE `entry`=122319; -- Darkfang
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131318; -- Elder Leaxa
UPDATE `creature_template` SET `HealthModifier`=246.153839111328125, `VerifiedBuild`=46597 WHERE `entry`=32913; -- Elder Ironbranch
UPDATE `creature_template` SET `HealthModifier`=246.153839111328125, `VerifiedBuild`=46597 WHERE `entry`=32914; -- Elder Stonebark
UPDATE `creature_template` SET `HealthModifier`=323.076934814453125, `VerifiedBuild`=46597 WHERE `entry`=32915; -- Elder Brightleaf
UPDATE `creature_template` SET `HealthModifier`=46.15384674072265625, `movementId`=121, `VerifiedBuild`=46597 WHERE `entry`=32919; -- Storm Lasher
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `HealthModifier`=30, `VerifiedBuild`=46597 WHERE `entry`=59789; -- Thalnos the Soulrender
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=135903; -- Manifestation of the Deep
UPDATE `creature_template` SET `HealthModifier`=0.75, `VerifiedBuild`=46597 WHERE `entry`=59822; -- Auntie Stormstout
UPDATE `creature_template` SET `HealthModifier`=0.075000002980232238, `VerifiedBuild`=46597 WHERE `entry`=59824; -- Golden Hopling
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=77816; -- Borka the Brute
UPDATE `creature_template` SET `HealthScalingExpansion`=4, `HealthModifier`=50, `VerifiedBuild`=46597 WHERE `entry`=59930; -- Empowered Zombie
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=131595; -- Governess Tabitha
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131615; -- Head Vintner Justin
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131617; -- Groundskeeper Lilith
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131619; -- Seamstress Johanna
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=33134; -- Sara
UPDATE `creature_template` SET `HealthModifier`=53.35146331787109375, `VerifiedBuild`=46597 WHERE `entry`=33136; -- Guardian of Yogg-Saron
UPDATE `creature_template` SET `type_flags2`=128, `VerifiedBuild`=46597 WHERE `entry`=95833; -- Hyrja
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=77927; -- Son of the Beast
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=95843; -- King Haldor
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131667; -- Soulbound Goliath
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=82428; -- Emberscale Ironflight
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=136160; -- King Dazar
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=86918; -- Uncharged Construct
UPDATE `creature_template` SET `HealthModifier`=38.46154022216796875, `VerifiedBuild`=46597 WHERE `entry`=33202; -- Ancient Water Spirit
UPDATE `creature_template` SET `HealthModifier`=32, `VerifiedBuild`=46597 WHERE `entry`=95886; -- Ash'Golm
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=95888; -- Cordana Felsong
UPDATE `creature_template` SET `HealthModifier`=35, `VerifiedBuild`=46597 WHERE `entry`=145185; -- Gnomercy 4.U.
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=100436; -- Illysanna Ravencrest
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=172093; -- Hearty Haunch
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=172094; -- Dissectible Dessert
UPDATE `creature_template` SET `HealthModifier`=980, `VerifiedBuild`=46597 WHERE `entry`=46753; -- Al'Akir
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=131853; -- Huntmaster Grath
UPDATE `creature_template` SET `HealthModifier`=35, `VerifiedBuild`=46597 WHERE `entry`=113971; -- Maiden of Virtue
UPDATE `creature_template` SET `HealthModifier`=15, `VerifiedBuild`=46597 WHERE `entry`=37890; -- Cult Fanatic
UPDATE `creature_template` SET `HealthModifier`=0.75, `VerifiedBuild`=46597 WHERE `entry`=60276; -- Hozen Clinger
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=122969; -- Zanchuli Witch-Doctor
UPDATE `creature_template` SET `HealthModifier`=0.300000011920928955, `VerifiedBuild`=46597 WHERE `entry`=42428; -- Devout Follower
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=127503; -- Overseer Korgus
UPDATE `creature_template` SET `HealthModifier`=519.23077392578125, `VerifiedBuild`=46597 WHERE `entry`=33524; -- Saronite Animus
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=172312; -- Spinemaw Gorger
UPDATE `creature_template` SET `HealthModifier`=15, `VerifiedBuild`=46597 WHERE `entry`=38009; -- Reanimated Fanatic
UPDATE `creature_template` SET `HealthModifier`=15, `ManaModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=38010; -- Reanimated Adherent
UPDATE `creature_template` SET `HealthModifier`=1.923076868057250976, `VerifiedBuild`=46597 WHERE `entry`=33572; -- Steelforged Defender
UPDATE `creature_template` SET `HealthModifier`=15, `VerifiedBuild`=46597 WHERE `entry`=38135; -- Deformed Fanatic
UPDATE `creature_template` SET `HealthModifier`=50, `VerifiedBuild`=46597 WHERE `entry`=150159; -- King Gobbamak
UPDATE `creature_template` SET `HealthModifier`=7.692307472229003906, `VerifiedBuild`=46597 WHERE `entry`=33768; -- Rubble
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=83026; -- Siegemaster Olugar
UPDATE `creature_template` SET `HealthModifier`=48, `VerifiedBuild`=46597 WHERE `entry`=29305; -- Moorabi
UPDATE `creature_template` SET `HealthModifier`=65, `VerifiedBuild`=46597 WHERE `entry`=150190; -- HK-8 Aerial Oppression Unit
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=154741; -- Squirt Bot
UPDATE `creature_template` SET `HealthScalingExpansion`=3, `HealthModifier`=40, `VerifiedBuild`=46597 WHERE `entry`=47297; -- Lumbering Oaf
UPDATE `creature_template` SET `HealthModifier`=16, `VerifiedBuild`=46597 WHERE `entry`=150295; -- Tank Buster MK1
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=96609; -- Gildedfur Stag
UPDATE `creature_template` SET `HealthModifier`=33.84615325927734375, `VerifiedBuild`=46597 WHERE `entry`=34035; -- Feral Defender
UPDATE `creature_template` SET `HealthModifier`=38.46154022216796875, `VerifiedBuild`=46597 WHERE `entry`=34057; -- Assault Bot
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=137036; -- Awoken Void
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=96754; -- Harbaron
UPDATE `creature_template` SET `ManaModifier`=0.000350554008036851, `VerifiedBuild`=46597 WHERE `entry`=96756; -- Ymiron, the Fallen King
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=155056; -- Robo-Waste
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=74475; -- Magmolatus
UPDATE `creature_template` SET `HealthModifier`=100, `VerifiedBuild`=46597 WHERE `entry`=52148; -- Jin'do the Godbreaker
UPDATE `creature_template` SET `HealthModifier`=45, `VerifiedBuild`=46597 WHERE `entry`=56636; -- Commander Ri'mok
UPDATE `creature_template` SET `HealthModifier`=57.5, `VerifiedBuild`=46597 WHERE `entry`=56637; -- Ook-Ook
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=137233; -- Plague Toad
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=74570; -- Ruination
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=74571; -- Calamity
UPDATE `creature_template` SET `HealthScalingExpansion`=3, `HealthModifier`=50, `VerifiedBuild`=46597 WHERE `entry`=47739; -- "Captain" Cookie
UPDATE `creature_template` SET `HealthModifier`=45, `VerifiedBuild`=46597 WHERE `entry`=56717; -- Hoptallus
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=141792; -- Liz Vilepot
UPDATE `creature_template` SET `HealthModifier`=37.5, `VerifiedBuild`=46597 WHERE `entry`=56732; -- Liu Flameheart
UPDATE `creature_template` SET `HealthModifier`=9, `VerifiedBuild`=46597 WHERE `entry`=61213; -- Krik'thik Conscript
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=141800; -- Brutik Blackanvil
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=141805; -- Threshanator 3000
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=56747; -- Gu Cloudstrike
UPDATE `creature_template` SET `HealthModifier`=45, `VerifiedBuild`=46597 WHERE `entry`=61243; -- Gekkan
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=164218; -- Lord Chamberlain
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=97081; -- King Bjorn
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=97083; -- King Ranulf
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=97084; -- King Tor
UPDATE `creature_template` SET `HealthModifier`=28.35000038146972656, `VerifiedBuild`=46597 WHERE `entry`=164255; -- Globgrog
UPDATE `creature_template` SET `HealthModifier`=10, `VerifiedBuild`=46597 WHERE `entry`=52392; -- Gurubashi Master Chef
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=74787; -- Slave Watcher Crushto
UPDATE `creature_template` SET `HealthModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=52405; -- Mor'Lek the Dismantler
UPDATE `creature_template` SET `HealthModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=52414; -- Tor-Tun
UPDATE `creature_template` SET `HealthModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=52418; -- Lost Offspring of Gahz'ranka
UPDATE `creature_template` SET `HealthModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=52422; -- Kaulema the Mover
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=97200; -- Seacursed Soulkeeper
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=83775; -- Ogron Laborer
UPDATE `creature_template` SET `HealthModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=52438; -- Mortaxx
UPDATE `creature_template` SET `HealthModifier`=1, `VerifiedBuild`=46597 WHERE `entry`=164363; -- Undying Stonefiend
UPDATE `creature_template` SET `HealthModifier`=16, `VerifiedBuild`=46597 WHERE `entry`=52440; -- Gub
UPDATE `creature_template` SET `HealthModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=52442; -- Florawing Hive Queen
UPDATE `creature_template` SET `HealthModifier`=4.5, `VerifiedBuild`=46597 WHERE `entry`=56930; -- Krik'thik Swarm Bringer
UPDATE `creature_template` SET `HealthModifier`=200, `VerifiedBuild`=46597 WHERE `entry`=61427; -- Subetai the Swift
UPDATE `creature_template` SET `HealthModifier`=0.75, `VerifiedBuild`=46597 WHERE `entry`=61431; -- Glintrok Scout
UPDATE `creature_template` SET `HealthModifier`=30, `VerifiedBuild`=46597 WHERE `entry`=61442; -- Kuai the Brute
UPDATE `creature_template` SET `HealthModifier`=9, `VerifiedBuild`=46597 WHERE `entry`=34605; -- Swarm Scarab
UPDATE `creature_template` SET `HealthModifier`=4.875, `VerifiedBuild`=46597 WHERE `entry`=137588; -- Gasping Flounder
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=164450; -- Dealer Xy'exa
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=128652; -- Viq'Goth
UPDATE `creature_template` SET `HealthModifier`=1559, `VerifiedBuild`=46597 WHERE `entry`=52571; -- Majordomo Staghelm
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=155543; -- Helpless Critter
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=164501; -- Mistcaller
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=164517; -- Tred'ova
UPDATE `creature_template` SET `HealthModifier`=0.75, `VerifiedBuild`=46597 WHERE `entry`=43658; -- Frenzied Crocolisk
UPDATE `creature_template` SET `HealthModifier`=45, `VerifiedBuild`=46597 WHERE `entry`=61567; -- Vizier Jin'bak
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=155595; -- Sacred Gear
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=155645; -- Walkie Shockie X2
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=151168; -- Annihilo-tron 5000
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=101950; -- Mindflayer Kaahrj
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=101951; -- Shivermaw
UPDATE `creature_template` SET `HealthModifier`=541.4100341796875, `VerifiedBuild`=46597 WHERE `entry`=110907; -- Star Augur Etraeus
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=101976; -- Millificent Manastorm
UPDATE `creature_template` SET `HealthModifier`=70, `VerifiedBuild`=46597 WHERE `entry`=34826; -- Mistress of Pain
UPDATE `creature_template` SET `HealthModifier`=18.75, `VerifiedBuild`=46597 WHERE `entry`=61699; -- Sik'thik Amberwing
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=101995; -- Festerface
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=155760; -- Tank Buster MK2
UPDATE `creature_template` SET `HealthModifier`=12.82999992370605468, `VerifiedBuild`=46597 WHERE `entry`=111008; -- Hatespawn Abomination
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102169; -- Black Bile
UPDATE `creature_template` SET `HealthModifier`=75, `VerifiedBuild`=46597 WHERE `entry`=61884; -- Xin the Weaponmaster
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102246; -- Anub'esset
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=102266; -- Violet Hold Guard
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102269; -- Felstalker Ravener
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102270; -- Eredar Invader
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102272; -- Felguard Destroyer
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102273; -- Doomguard Infiltrator
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102282; -- Lord Malgath
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=164967; -- Doctor Ickus
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=75452; -- Bonemaw
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=142625; -- Ledley the Bold
UPDATE `creature_template` SET `HealthModifier`=55, `VerifiedBuild`=46597 WHERE `entry`=39665; -- Rom'ogg Bonecrusher
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=129208; -- Dread Captain Lockwood
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=165073; -- Forlorn Captive
UPDATE `creature_template` SET `HealthModifier`=5, `VerifiedBuild`=46597 WHERE `entry`=115831; -- Mana Devourer
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=151654; -- Deuce Mecha-Buffer
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=84520; -- Pitwarden Gwarnok
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=102431; -- Blood-Princess Thal'ena
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=169617; -- Duraka the Unbreakable
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=138314; -- Patches
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `HealthModifier`=2.20000004768371582, `VerifiedBuild`=46597 WHERE `entry`=174272; -- Violet Hold Guard
UPDATE `creature_template` SET `HealthModifier`=1.125, `VerifiedBuild`=46597 WHERE `entry`=39984; -- Malignant Trogg
UPDATE `creature_template` SET `HealthModifier`=14, `ManaModifier`=20, `VerifiedBuild`=46597 WHERE `entry`=39987; -- Evolved Twilight Zealot
UPDATE `creature_template` SET `HealthScalingExpansion`=0, `VerifiedBuild`=46597 WHERE `entry`=75829; -- Nhallish
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=98246; -- Risen Warrior
UPDATE `creature_template` SET `type_flags`=2097768, `VerifiedBuild`=46597 WHERE `entry`=165408; -- Halkias
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=134069; -- Vol'zith the Whisperer
UPDATE `creature_template` SET `HealthModifier`=4, `ManaModifier`=1, `VerifiedBuild`=46597 WHERE `entry`=26627; -- Crystal Handler
UPDATE `creature_template` SET `HealthModifier`=5, `VerifiedBuild`=46597 WHERE `entry`=26628; -- Drakkari Scytheclaw
UPDATE `creature_template` SET `HealthModifier`=5, `VerifiedBuild`=46597 WHERE `entry`=26641; -- Drakkari Gutripper
# UPDATE `creature_template` SET `VerifiedBuild`=46597 WHERE `entry`=98293; -- Saltsea Globule
UPDATE `creature_template` SET `HealthModifier`=2, `VerifiedBuild`=46597 WHERE `entry`=165556; -- Fleeting Manifestation
UPDATE `creature_template` SET `HealthModifier`=333.20001220703125, `VerifiedBuild`=46597 WHERE `entry`=53694; -- Riplimb
UPDATE `creature_template` SET `HealthModifier`=333.20001220703125, `VerifiedBuild`=46597 WHERE `entry`=53695; -- Rageface
