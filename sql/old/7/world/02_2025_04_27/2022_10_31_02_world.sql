...
(8842, 0, 0, 'Who is the Headless Horseman?', 22620, 8880, 0, 0, 0, NULL, 0, 46340);
...
-- Old creature spawns
DELETE FROM `creature` WHERE `guid` BETWEEN 361993 AND 362033;
DELETE FROM `game_event_creature` WHERE `guid` BETWEEN 361993 AND 362033;

-- Creature spawns
DELETE FROM `creature` WHERE `guid` BETWEEN @CGUID+0 AND @CGUID+46;
INSERT INTO `creature` (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnDifficulties`, `PhaseId`, `PhaseGroup`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `wander_distance`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `dynamicflags`, `VerifiedBuild`) VALUES
(@CGUID+0, 5953, 1, 14, 362, '0', 0, 0, 0, 1, 241.359375, -4562.96875, 18.58214569091796875, 5.8817596435546875, 120, 0, 0, 3412, 0, 0, 0, 0, 0, 46340), -- Razor Hill Grunt (Area: Razor Hill - Difficulty: 0)
(@CGUID+1, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 320.015625, -4694.52783203125, 29.4495086669921875, 5.497786998748779296, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+2, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 328.9674072265625, -4767.37548828125, 12.65957260131835937, 4.555309295654296875, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+3, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 314.915679931640625, -4774.04248046875, 17.21193504333496093, 3.246312379837036132, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+4, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 301.627777099609375, -4776.4580078125, 19.42165946960449218, 5.009094715118408203, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+5, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 283.484375, -4701.048828125, 16.75503921508789062, 2.879793167114257812, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+6, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 274.395843505859375, -4716.43408203125, 21.21046638488769531, 1.989675283432006835, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+7, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 317.086334228515625, -4772.23291015625, 25.44216156005859375, 3.298672199249267578, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+8, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 311.118072509765625, -4689.25341796875, 17.54905319213867187, 4.729842185974121093, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42091 - Headless Horseman - Fire Size, 42154 - Headless Horseman - Dim Fire)
(@CGUID+9, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 302.1212158203125, -4776.34912109375, 10.57410621643066406, 4.066617012023925781, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+10, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 269.633697509765625, -4718.5087890625, 18.58950614929199218, 2.687807083129882812, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+11, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 282.0538330078125, -4709.189453125, 15.38826847076416015, 5.410520553588867187, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+12, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 285.630218505859375, -4700.109375, 13.22489070892333984, 2.460914134979248046, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+13, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 298.276214599609375, -4773.83349609375, 10.92465877532958984, 1.239183783531188964, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+14, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 303.8984375, -4773.7353515625, 27.47631263732910156, 4.031710624694824218, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+15, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 277.154510498046875, -4698.765625, 18.67828941345214843, 0.314159274101257324, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+16, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 275.420135498046875, -4718.0400390625, 15.38826847076416015, 0.541052043437957763, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+17, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 311.313751220703125, -4772.89013671875, 26.594024658203125, 4.660028934478759765, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+18, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 327.84722900390625, -4699.2412109375, 27.41243934631347656, 1.553343057632446289, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+19, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 293.19964599609375, -4708.68408203125, 13.19225120544433593, 1.448623299598693847, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+20, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 320.01214599609375, -4697.533203125, 16.79498481750488281, 6.056292533874511718, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+21, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 310.052093505859375, -4692.51416015625, 17.39514350891113281, 0.244346097111701965, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+22, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 313.395782470703125, -4698.97509765625, 15.42339229583740234, 0.122173048555850982, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+23, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 315.166015625, -4770.603515625, 11.82738018035888671, 3.577924966812133789, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+24, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 318.645843505859375, -4692.5, 20.45223426818847656, 2.408554315567016601, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+25, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 292.488067626953125, -4768.1298828125, 11.77597808837890625, 2.076941728591918945, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+26, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 312.780059814453125, -4771.0009765625, 11.3687744140625, 0.383972436189651489, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42091 - Headless Horseman - Fire Size, 42154 - Headless Horseman - Dim Fire)
(@CGUID+27, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 271.07464599609375, -4722.43603515625, 14.23592948913574218, 4.415682792663574218, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+28, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 324.720855712890625, -4768.03466796875, 12.421783447265625, 3.124139308929443359, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+29, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 317.743072509765625, -4690.56103515625, 29.57596206665039062, 1.361356854438781738, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42091 - Headless Horseman - Fire Size, 42154 - Headless Horseman - Dim Fire)
(@CGUID+30, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 283.125, -4706.24462890625, 15.45350933074951171, 3.50811171531677246, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+31, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 275.927093505859375, -4712.82666015625, 19.05101585388183593, 4.450589656829833984, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+32, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 339.46087646484375, -4711.14892578125, 16.30143165588378906, 0.157079637050628662, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+33, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 343.46527099609375, -4708.6806640625, 29.74063491821289062, 2.234021425247192382, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+34, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 338.38714599609375, -4705.84716796875, 27.86400604248046875, 3.071779489517211914, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+35, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 341.05902099609375, -4708.51220703125, 21.40582275390625, 6.195918560028076171, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42154 - Headless Horseman - Dim Fire)
(@CGUID+36, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 344.83160400390625, -4710.359375, 27.25813484191894531, 3.892084121704101562, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0) (Auras: 42091 - Headless Horseman - Fire Size, 42154 - Headless Horseman - Dim Fire)
(@CGUID+37, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 296.083343505859375, -4565.27978515625, 39.0418853759765625, 1.989675283432006835, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0)
(@CGUID+38, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 286.576385498046875, -4561.42529296875, 30.2720489501953125, 2.426007747650146484, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0)
(@CGUID+39, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 289.557281494140625, -4568.09033203125, 39.06153106689453125, 3.577924966812133789, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0)
(@CGUID+40, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 277.961822509765625, -4568.71337890625, 27.27142333984375, 4.118977069854736328, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0)
(@CGUID+41, 23537, 1, 14, 362, '0', 0, 0, 0, 0, 292.838531494140625, -4558.986328125, 31.27065467834472656, 2.39110112190246582, 120, 0, 0, 15017, 5751, 0, 0, 0, 0, 46340), -- Headless Horseman - Fire (DND) (Area: Razor Hill - Difficulty: 0)
(@CGUID+42, 23971, 1, 14, 362, '0', 0, 0, 0, 0, 358.94384765625, -4742.3623046875, 9.72699737548828125, 3.385938644409179687, 120, 0, 0, 27, 0, 0, 0, 0, 0, 46340), -- Traveling Orphan (Area: Razor Hill - Difficulty: 0)
(@CGUID+43, 23971, 1, 14, 362, '0', 0, 0, 0, 0, 358.99462890625, -4744.30029296875, 9.672590255737304687, 2.007128715515136718, 120, 0, 0, 41, 0, 0, 0, 0, 0, 46340), -- Traveling Orphan (Area: Razor Hill - Difficulty: 0)
(@CGUID+44, 23971, 1, 14, 362, '0', 0, 0, 0, 0, 357.807525634765625, -4740.90087890625, 9.787995338439941406, 4.15388345718383789, 120, 0, 0, 34, 0, 0, 0, 0, 0, 46340), -- Traveling Orphan (Area: Razor Hill - Difficulty: 0)
(@CGUID+45, 23971, 1, 14, 362, '0', 0, 0, 0, 0, 356.287811279296875, -4740.259765625, 9.8579864501953125, 4.555309295654296875, 120, 0, 0, 41, 0, 0, 0, 0, 0, 46340), -- Traveling Orphan (Area: Razor Hill - Difficulty: 0)
(@CGUID+46, 23973, 1, 14, 362, '0', 0, 0, 0, 0, 356.1212158203125, -4742.24462890625, 9.828121185302734375, 0.558505356311798095, 120, 0, 0, 18771, 0, 0, 0, 0, 0, 46340); -- Masked Orphan Matron (Area: Razor Hill - Difficulty: 0)

-- Old gameobject spawns
DELETE FROM `gameobject` WHERE `guid` BETWEEN 227182 AND 227240;
DELETE FROM `game_event_gameobject` WHERE `guid` BETWEEN 227182 AND 227240;
...
(@OGUID+57, 186615, 1, 14, 362, '0', 0, 0, 354.798614501953125, -4740.95166015625, 9.819157600402832031, 2.513273954391479492, 0, 0, 0.951056480407714843, 0.309017121791839599, 120, 255, 1, 46340), -- Water Buckets (Area: Razor Hill - Difficulty: 0)
(@OGUID+58, 186720, 1, 14, 362, '0', 0, 0, 286.564239501953125, -4561.45166015625, 30.18912696838378906, 2.426007747650146484, 0, 0, 0.936672210693359375, 0.350207358598709106, 120, 255, 1, 46340), -- Fire Effigy (Area: Razor Hill - Difficulty: 0)
(@OGUID+59, 186720, 1, 14, 362, '0', 0, 0, 289.557281494140625, -4568.09033203125, 38.97819900512695312, 2.251473426818847656, 0, 0, 0.902585029602050781, 0.430511653423309326, 120, 255, 1, 46340), -- Fire Effigy (Area: Razor Hill - Difficulty: 0)
(@OGUID+60, 186720, 1, 14, 362, '0', 0, 0, 278.171875, -4568.798828125, 26.74064064025878906, 1.640606880187988281, 0, 0, 0.731352806091308593, 0.6819993257522583, 120, 255, 1, 46340), -- Fire Effigy (Area: Razor Hill - Difficulty: 0)
(@OGUID+61, 186720, 1, 14, 362, '0', 0, 0, 296.095489501953125, -4565.25341796875, 38.96109771728515625, 1.343901276588439941, 0, 0, 0.622513771057128906, 0.78260880708694458, 120, 255, 1, 46340), -- Fire Effigy (Area: Razor Hill - Difficulty: 0)
(@OGUID+62, 186720, 1, 14, 362, '0', 0, 0, 292.40972900390625, -4558.6474609375, 30.90425682067871093, 3.281238555908203125, 0, 0, -0.99756336212158203, 0.069766148924827575, 120, 255, 1, 46340), -- Fire Effigy (Area: Razor Hill - Difficulty: 0)
(@OGUID+63, 190064, 1, 14, 362, '0', 0, 0, 342.447906494140625, -4687.626953125, 16.48921394348144531, 5.166176319122314453, 0, 0, -0.52991867065429687, 0.84804844856262207, 120, 255, 1, 46340); -- Candy Bucket (Area: Razor Hill - Difficulty: 0)
...
DELETE FROM `game_event_gameobject` WHERE `eventEntry`=12 AND `guid` BETWEEN @OGUID+0 AND @OGUID+63;
