...
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35250; -- Ghostly Night Elf Celebrant
UPDATE `creature_template` SET `gossip_menu_id`=10518 WHERE `entry`=46894; -- Ghostly Worgen Celebrant
