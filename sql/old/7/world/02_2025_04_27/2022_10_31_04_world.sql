...
UPDATE `creature_template` SET `faction`=188, `speed_run`=1, `BaseAttackTime`=2000, `unit_flags`=33555200, `unit_flags2`=67110912, `unit_flags3`=16777216 WHERE `entry`=109860; -- Crooked Tree Crow
UPDATE `creature_template` SET `faction`=14, `BaseAttackTime`=3000, `unit_flags`=32768, `unit_flags2`=2048 WHERE `entry`=109825; -- Aria Sorrowheart
UPDATE `creature_template` SET `faction`=188, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry`=109734; -- Hag of the Crooked Tree
