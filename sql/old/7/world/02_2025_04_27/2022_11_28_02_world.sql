...
UPDATE `creature_template` SET `unit_flags3`=1048576, `VerifiedBuild`=46702 WHERE `entry`=89051; -- Okuna Longtusk
UPDATE `creature_template` SET `gossip_menu_id`=19919, `VerifiedBuild`=46702 WHERE `entry`=109334; -- Okuna Longtusk
