...
-- Creature templates
UPDATE `creature_template` SET `gossip_menu_id`=6590 WHERE `entry`=15354; -- Rachelle Gothena
# UPDATE `creature_template` SET `minlevel`=30, `maxlevel`=30 WHERE `entry` IN (54170, 54146); -- Delian Sunshade
UPDATE `creature_template` SET `unit_flags`=537166080, `unit_flags2`=34817, `unit_flags3`=8192 WHERE `entry`=54142; -- Hired Courier
...
(6590, 0, 1, 'What Hallow''s End candy do you have for sale?', 10815, 0, 0, 0, 0, NULL, 0, 46366),
(6590, 1, 0, 'What is there to do on Hallow''s End?', 10816, 6593, 0, 0, 0, NULL, 0, 46366),
(12949, 0, 0, 'Have you seen anyone suspicious trying to sell a crate of objects recently?', 52757, 0, 0, 0, 0, NULL, 0, 46366);
