...
-- Creature templates
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35258; -- Ghostly Aldor Celebrant
UPDATE `creature_template` SET `gossip_menu_id`=10518 WHERE `entry`=35259; -- Ghostly Scryer Celebrant
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35260; -- Cheerful Aldor Spirit
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35261; -- Cheerful Scryer Spirit
