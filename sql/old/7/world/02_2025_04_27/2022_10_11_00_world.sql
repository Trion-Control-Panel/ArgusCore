...
(11901, 0, 0, 'I seem to have misplaced my sea pup, admiral. Do you have another that you could lend to me?', 45023, 0, 0, 0, 0, NULL, 0, 45745);
...
UPDATE `creature_template` SET `unit_flags3`=16777217 WHERE `entry`=44920; -- North Tide's Invisible Stalker
...
UPDATE `creature_template` SET `unit_flags3`=16777217 WHERE `entry`=44923; -- North Tide's Invisible Stalker (Large)
