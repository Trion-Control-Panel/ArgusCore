...
UPDATE `creature_template` SET `gossip_menu_id`=9471 WHERE `entry`=23973; -- Masked Orphan Matron
...
(9471, 0, 0, 'Who is the Headless Horseman?', 22620, 8880, 0, 0, 0, NULL, 0, 45745);

-- Scaling
DELETE FROM `creature_template_scaling` WHERE (`Entry` IN (23973,23971));
...
(11219, 0, 0, -1, 0, 0, 0, 20, 0, 1, 0, 0, 0, 0, 45745),           -- Stop the Fires!
(11450, 0, 1, 0, 262899, 23537, 530, 462, 0, 3, 0, 0, 0, 0, 45745), -- Fire Training
(11450, 0, 0, -1, 0, 0, 530, 462, 0, 1, 0, 0, 0, 0, 45745); -- Fire Training
...
(11219, 0, 0, 2240, 283, 45745), -- Stop the Fires!
(11450, 1, 3, 9265, -6812, 45745), -- Fire Training
(11450, 1, 2, 9211, -6809, 45745), -- Fire Training
(11450, 1, 1, 9216, -6761, 45745), -- Fire Training
(11450, 1, 0, 9257, -6761, 45745), -- Fire Training
(11450, 0, 0, 9516, -6815, 45745); -- Fire Training
