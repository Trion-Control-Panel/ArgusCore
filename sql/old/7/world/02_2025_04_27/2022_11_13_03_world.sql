...
UPDATE `creature_template` SET `speed_run`=1, `BaseAttackTime`=2000, `unit_flags`=512, `unit_flags2`=2048, `unit_flags3`=1, `VerifiedBuild`=46547 WHERE `entry`=107279; -- Wand Target
