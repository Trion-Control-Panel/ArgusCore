...
UPDATE `creature_template` SET `faction`=190, `speed_run`=2.857142925262451171, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2099200, `HoverHeight`=5.849999904632568359 WHERE `entry`=90546; -- Stellagosa
