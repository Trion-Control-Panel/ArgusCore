...
UPDATE `creature_template` SET `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=32768, `HoverHeight`=5.849999904632568359, `VerifiedBuild`=46455 WHERE `entry`=90065; -- Stellagosa
