...
UPDATE `creature_template` SET `gossip_menu_id`=6536, `BaseAttackTime`=3000 WHERE `entry`=15195; -- Wickerman Guardian
...
UPDATE `creature_template` SET `gossip_menu_id`=8945, `npcflag`=1 WHERE `entry`=19178; -- Forsaken Commoner
UPDATE `creature_template` SET `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=51720; -- Wickerman Torch Point
...
UPDATE `creature_template` SET `npcflag`=16777216, `speed_run`=1.385714292526245117, `unit_flags`=33554432, `unit_flags2`=67584, `VehicleId`=1690 WHERE `entry`=53761; -- Crone's Broom
UPDATE `creature_template` SET `speed_run`=1.385714292526245117, `unit_flags`=33554432, `unit_flags2`=67584 WHERE `entry`=53762; -- Crone
...
(12929, 0, 0, 'I''m ready to attack Stormwind!', 52463, 0, 0, 0, 0, NULL, 0, 45745);
