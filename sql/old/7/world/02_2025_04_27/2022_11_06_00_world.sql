...
UPDATE `creature_template` SET `BaseAttackTime`=2000, `unit_flags`=32768, `dynamicflags`=128, `VerifiedBuild`=46366 WHERE `entry`=90880; -- Mana-Drained Whelpling
UPDATE `creature_template` SET `BaseAttackTime`=2000, `unit_flags`=32832, `unit_flags2`=2048, `unit_flags3`=8388608, `VerifiedBuild`=46366 WHERE `entry`=90543; -- Agapanthus
