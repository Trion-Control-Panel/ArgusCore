...
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35253; -- Ghostly Troll Celebrant
UPDATE `creature_template` SET `gossip_menu_id`=10518 WHERE `entry`=46891; -- Ghostly Goblin Celebrant
