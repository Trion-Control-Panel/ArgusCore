...
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35247; -- Ghostly Dwarf Celebrant
UPDATE `creature_template` SET `gossip_menu_id`=10518, `unit_flags`=768 WHERE `entry`=35248; -- Ghostly Gnome Celebrant
