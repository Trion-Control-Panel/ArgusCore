...
UPDATE `creature_template` SET `gossip_menu_id`=11385,  `unit_flags`=32768 WHERE `entry`=40435; -- Headless Ghost
...
UPDATE `creature_template` SET  `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=51684; -- Wickerman Torch Point
...
UPDATE `creature_template` SET  `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=51702; -- Wickerman Crowd Bunny 01
UPDATE `creature_template` SET  `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=51703; -- Wickerman Crowd Bunny 02
UPDATE `creature_template` SET  `unit_flags3`=16777216, `flags_extra`=`flags_extra`|128 WHERE `entry`=51705; -- Wickerman Crowd Bunny 03
UPDATE `creature_template` SET  `npcflag`=16777216, `speed_run`=1.385714292526245117, `unit_flags`=33554432, `unit_flags2`=67584, `VehicleId`=1555 WHERE `entry`=51710; -- Hag's Broom
UPDATE `creature_template` SET  `speed_run`=1.385714292526245117, `unit_flags`=33554432, `unit_flags2`=67584 WHERE `entry`=51836; -- Hag
...
UPDATE `creature_template` SET  `flags_extra`=`flags_extra`|128 WHERE `entry`=52067; -- General Purpose Bunny (All Phases)
...
UPDATE `creature_template` SET  `flags_extra`=`flags_extra`|128 WHERE `entry`=53966; -- Spider Summoner (Ship)
...
UPDATE `creature_template` SET  `flags_extra`=`flags_extra`|128 WHERE `entry`=54043; -- Spider Summoner (Catacombs)
# UPDATE `creature_template` SET `minlevel`=60, `maxlevel`=60 WHERE `entry`=54072; -- Sanath Lim-yo
UPDATE `creature_template` SET  `unit_flags`=512, `unit_flags3`=524288 WHERE `entry`=54114; -- Unleashed Void
...
#UPDATE `creature_template` SET `gossip_menu_id`=23176 WHERE `entry`=142656; -- Kalendormu
...
(11385, 0, 20, 'Queue for The Headless Horseman battle.', 40427, 0, 0, 0, 0, NULL, 0, 45745),
(12941, 1, 0, 'Has anyone suspicious tried to list a crate of goods recently?', 52636, 0, 0, 0, 0, NULL, 0, 45745),
(23176, 0, 0, 'What is a member of the Bronze Dragonflight doing here?', 160752, 23177, 0, 0, 0, NULL, 0, 45745);
...
-- Scaling
DELETE FROM `creature_template_scaling` WHERE `Entry` IN (15310, 51665, 51666, 51684, 51699, 51701, 51702, 51703, 51705, 51710, 51836, 51934, 51947, 52064, 52067, 52497, 52548, 53702, 53728, 53869, 53949, 53950, 53954, 53961, 53965, 53966, 54021, 54032, 54043, 54072, 54114, 54118, 54205, 109685, 142656, 181575);
...
(29402, 0, 5, 32, 0, 0, 0, 301, 0, 0, 0, 0, 598923, 0, 45745),   -- Taking Precautions
(29402, 0, 4, 2, 252054, 71035, 0, 301, 0, 7, 0, 0, 0, 0, 45745), -- Taking Precautions
(29402, 2, 3, 1, 252053, 3371, 0, 301, 0, 7, 0, 0, 0, 0, 45745),  -- Taking Precautions
(29402, 1, 2, 1, 252053, 3371, 0, 301, 0, 7, 0, 0, 0, 0, 45745),  -- Taking Precautions
(29402, 0, 1, 1, 252053, 3371, 0, 301, 0, 7, 0, 0, 0, 0, 45745),  -- Taking Precautions
(29402, 0, 0, -1, 0, 0, 0, 301, 0, 1, 0, 0, 0, 0, 45745); -- Taking Precautions
...
(29402, 5, 0, -8532, 608, 45745), -- Taking Precautions
(29402, 4, 11, -8295, 628, 45745), -- Taking Precautions
(29402, 4, 10, -8336, 688, 45745), -- Taking Precautions
(29402, 4, 9, -8308, 723, 45745), -- Taking Precautions
(29402, 4, 8, -8262, 833, 45745), -- Taking Precautions
(29402, 4, 7, -8170, 939, 45745), -- Taking Precautions
(29402, 4, 6, -8102, 937, 45745), -- Taking Precautions
(29402, 4, 5, -8069, 924, 45745), -- Taking Precautions
(29402, 4, 4, -8054, 839, 45745), -- Taking Precautions
(29402, 4, 3, -8054, 769, 45745), -- Taking Precautions
(29402, 4, 2, -8056, 729, 45745), -- Taking Precautions
(29402, 4, 1, -8168, 547, 45745), -- Taking Precautions
(29402, 4, 0, -8218, 541, 45745), -- Taking Precautions
(29402, 3, 11, -8524, 798, 45745), -- Taking Precautions
(29402, 3, 10, -8527, 806, 45745), -- Taking Precautions
(29402, 3, 9, -8529, 814, 45745), -- Taking Precautions
(29402, 3, 8, -8527, 821, 45745), -- Taking Precautions
(29402, 3, 7, -8522, 826, 45745), -- Taking Precautions
(29402, 3, 6, -8512, 823, 45745), -- Taking Precautions
(29402, 3, 5, -8507, 818, 45745), -- Taking Precautions
(29402, 3, 4, -8504, 813, 45745), -- Taking Precautions
(29402, 3, 3, -8504, 806, 45745), -- Taking Precautions
(29402, 3, 2, -8504, 800, 45745), -- Taking Precautions
(29402, 3, 1, -8511, 795, 45745), -- Taking Precautions
(29402, 3, 0, -8517, 795, 45745), -- Taking Precautions
(29402, 2, 11, -8871, 615, 45745), -- Taking Precautions
(29402, 2, 10, -8874, 621, 45745), -- Taking Precautions
(29402, 2, 9, -8876, 628, 45745), -- Taking Precautions
(29402, 2, 8, -8877, 633, 45745), -- Taking Precautions
(29402, 2, 7, -8877, 641, 45745), -- Taking Precautions
(29402, 2, 6, -8869, 644, 45745), -- Taking Precautions
(29402, 2, 5, -8858, 644, 45745), -- Taking Precautions
(29402, 2, 4, -8854, 638, 45745), -- Taking Precautions
(29402, 2, 3, -8849, 630, 45745), -- Taking Precautions
(29402, 2, 2, -8849, 618, 45745), -- Taking Precautions
(29402, 2, 1, -8854, 612, 45745), -- Taking Precautions
(29402, 2, 0, -8861, 612, 45745), -- Taking Precautions
(29402, 1, 11, -8969, 886, 45745), -- Taking Precautions
(29402, 1, 10, -8970, 898, 45745), -- Taking Precautions
(29402, 1, 9, -8970, 904, 45745), -- Taking Precautions
(29402, 1, 8, -8967, 911, 45745), -- Taking Precautions
(29402, 1, 7, -8962, 914, 45745), -- Taking Precautions
(29402, 1, 6, -8944, 921, 45745), -- Taking Precautions
(29402, 1, 5, -8941, 913, 45745), -- Taking Precautions
(29402, 1, 4, -8939, 901, 45745), -- Taking Precautions
(29402, 1, 3, -8939, 893, 45745), -- Taking Precautions
(29402, 1, 2, -8944, 886, 45745), -- Taking Precautions
(29402, 1, 1, -8952, 881, 45745), -- Taking Precautions
(29402, 1, 0, -8959, 881, 45745), -- Taking Precautions
(29402, 0, 0, -8532, 608, 45745); -- Taking Precautions
