...
-- Creature Template
UPDATE `creature_template` SET `faction`=1555, `npcflag`=128, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry`=123735; -- Henry Gust
UPDATE `creature_template` SET `gossip_menu_id`=21057, `faction`=1555, `npcflag`=1, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry`=120928; -- Jay Maguire
UPDATE `creature_template` SET `faction`=1555, `npcflag`=128, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry`=121542; -- Nick Arse
UPDATE `creature_template` SET `faction`=1555, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry` IN (121537, 123691, 121535); -- Metal Fan
UPDATE `creature_template` SET `faction`=1555, `npcflag`=128, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry`=121543; -- Khan Nabul
#UPDATE `creature_template` SET `gossip_menu_id`=26433, `faction`=1555, `npcflag`=1, `BaseAttackTime`=2000, `unit_flags`=768, `unit_flags2`=2048 WHERE `entry`=174035; -- Dro Seminario
