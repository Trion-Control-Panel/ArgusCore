...
ALTER TABLE `item_random_properties_locale`
DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `item_random_suffix_locale`
DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `world_map_transforms`
DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `world_safe_locs`
DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `world_safe_locs_locale`
DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
DROP INDEX `idx_locale`,
  ENGINE=InnoDB
