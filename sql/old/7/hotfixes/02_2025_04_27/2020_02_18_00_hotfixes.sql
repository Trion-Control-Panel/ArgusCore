...
ALTER TABLE `garr_plot_locale` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `item_random_properties` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `item_random_properties_locale` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `item_random_suffix` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `item_random_suffix_locale` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `item_upgrade` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `pvp_reward` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `pvp_talent_unlock` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `ruleset_item_upgrade` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `sandbox_scaling` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `spell` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `spell_locale` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `world_map_area` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `world_map_overlay` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `world_map_transforms` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `world_safe_locs` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `world_safe_locs_locale` MODIFY `VerifiedBuild` int(11) NOT NULL DEFAULT '0';
