...
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=341 AND `DifficultyID`=0); -- 341 (Foreman Oslow) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=648 AND `DifficultyID`=0); -- 648 (Bridge Worker Trent) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=649 AND `DifficultyID`=0); -- 649 (Bridge Worker Dmitri) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=650 AND `DifficultyID`=0); -- 650 (Bridge Worker Jess) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=651 AND `DifficultyID`=0); -- 651 (Bridge Worker Daniel) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=652 AND `DifficultyID`=0); -- 652 (Bridge Worker Matthew) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=653 AND `DifficultyID`=0); -- 653 (Bridge Worker Alex) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=43094 AND `DifficultyID`=0); -- 43094 (Canyon Ettin) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0 WHERE (`Entry`=43197 AND `DifficultyID`=0); -- 43197 (Subdued Canyon Ettin) -
