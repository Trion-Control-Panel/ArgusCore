...
UPDATE `creature_template_difficulty` SET `StaticFlags1`=536871168 WHERE (`Entry`=59626 AND `DifficultyID`=0); -- 59626 (Flame Spout) - Sessile, Floating
UPDATE `creature_template_difficulty` SET `StaticFlags1`=268435456 WHERE (`Entry`=60176 AND `DifficultyID`=0); -- 60176 (Huojin Monk) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=268435456 WHERE (`Entry`=54135 AND `DifficultyID`=0); -- 54135 (Master Li Fei) - CanSwim
