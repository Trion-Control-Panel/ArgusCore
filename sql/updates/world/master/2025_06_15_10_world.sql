...
UPDATE `gossip_menu_option` SET `OptionBroadcastTextID`=106049, `VerifiedBuild`=61265 WHERE (`MenuID`=19321 AND `OptionID`=2); -- OptionBroadcastTextID: 106049 - 128607
