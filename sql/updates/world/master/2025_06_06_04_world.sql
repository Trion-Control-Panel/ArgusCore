...
-- Difficulty (Normal)
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x30000100 WHERE (`Entry`=100652 AND `DifficultyID`=1); -- 100652 (Malfurion Stormrage) - Sessile, CanSwim, Floating
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x30000100 WHERE (`Entry`=101329 AND `DifficultyID`=1); -- 101329 (Nightmare Bindings) - Sessile, CanSwim, Floating - CannotTurn
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=0, `LevelScalingDeltaMax`=0, `StaticFlags1`=0x10000000 WHERE (`Entry`=99192 AND `DifficultyID`=1); -- 99192 (Shade of Xavius) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x20000100 WHERE (`Entry`=111042 AND `DifficultyID`=1); -- 111042 (Nightmare Fire) - Sessile, Floating
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x30000100 WHERE (`Entry`=101072 AND `DifficultyID`=1); -- 101072 (Corrupted Dragon Egg) - Sessile, CanSwim, Floating
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=100526 AND `DifficultyID`=1); -- 100526 (Tormented Bloodseeker) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=99366 AND `DifficultyID`=1); -- 99366 (Taintheart Summoner) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=100527 AND `DifficultyID`=1); -- 100527 (Dreadfire Imp) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=99359 AND `DifficultyID`=1); -- 99359 (Rotheart Keeper) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000100 WHERE (`Entry`=99360 AND `DifficultyID`=1); -- 99360 (Vilethorn Blossom) - Sessile, CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=99358 AND `DifficultyID`=1); -- 99358 (Rotheart Dryad) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=107638 AND `DifficultyID`=1); -- 107638 (Druidic Preserver) - CanSwim
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=0, `LevelScalingDeltaMax`=0, `StaticFlags1`=0x10000000 WHERE (`Entry`=99200 AND `DifficultyID`=1); -- 99200 (Dresaron) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=99365 AND `DifficultyID`=1); -- 99365 (Taintheart Stalker) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=100539 AND `DifficultyID`=1); -- 100539 (Taintheart Deadeye) - CanSwim
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=0, `LevelScalingDeltaMax`=0, `StaticFlags1`=0x10000000 WHERE (`Entry`=96512 AND `DifficultyID`=1); -- 96512 (Archdruid Glaidalis) - CanSwim
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=1, `LevelScalingDeltaMax`=1, `StaticFlags1`=0x10000000 WHERE (`Entry`=100531 AND `DifficultyID`=1); -- 100531 (Bloodtainted Fury) - CanSwim
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=0, `LevelScalingDeltaMax`=0, `StaticFlags1`=0x10000100 WHERE (`Entry`=103344 AND `DifficultyID`=1); -- 103344 (Oakheart) - Sessile, CanSwim
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=1, `LevelScalingDeltaMax`=1, `StaticFlags1`=0x10000000 WHERE (`Entry`=95766 AND `DifficultyID`=1); -- 95766 (Crazed Razorbeak) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=95769 AND `DifficultyID`=1); -- 95769 (Mindshattered Screecher) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=95771 AND `DifficultyID`=1); -- 95771 (Dreadsoul Ruiner) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=100400 AND `DifficultyID`=1); -- 100400 (Dead Perserver Druid) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=101991 AND `DifficultyID`=1); -- 101991 (Nightmare Dweller) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=100529 AND `DifficultyID`=1); -- 100529 (Hatespawn Slime) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=101679 AND `DifficultyID`=1); -- 101679 (Dreadsoul Poisoner) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=95772 AND `DifficultyID`=1); -- 95772 (Frenzied Nightclaw) - CanSwim
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=0, `LevelScalingDeltaMax`=0, `StaticFlags1`=0x10000000 WHERE (`Entry`=95779 AND `DifficultyID`=1); -- 95779 (Festerhide Grizzly) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000 WHERE (`Entry`=100403 AND `DifficultyID`=1); -- 100403 (Druidic Preserver) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x30000100 WHERE (`Entry`=100533 AND `DifficultyID`=1); -- 100533 (Corrupted Egg) - Sessile, CanSwim, Floating
